...
|----------|:-------------:|:------:|------|------|
|cfgAcEnabled| off | on | AC discharge (INV) switch setting | {valName:enabled,moduleType:3,operateType:acOutCfg,params:{out_voltage:-1,out_freq:255,xboost:255,enabled:1}} |
