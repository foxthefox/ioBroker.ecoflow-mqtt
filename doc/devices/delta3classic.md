...
|plugInInfoDcp2Amp|0 | 15 | A | 1 |  plug in info dcp2 amp |
|plugInInfoDcp2Vol|0 | 65 | V | 1 |  plug in info pv2 voltage |
|plugInInfo_12vVol|0 | 16 | V | 1 |  plug in info 12V vol |
|plugInInfo_12vAmp|0 | 15 | A | 1 |  plug in info 12V amp |
|llcBatVol|0 | 60 | V | 1 |  llc bat vol |
|llcBatCur|0 | 15 | A | 1 |  llc bat amp |
|llcBusVol|0 | 60 | V | 1 |  llc bus vol |
|dcdcChgReqCur|0 | 15 | A | 1 |  dcdc Chg Req Cur |
...
| State  |  Name |
|----------|------|
|plugInInfo_12vAmpList| 12V amp list |
|plugInInfoAcOutAmpList| Ac Out Amp List |
...
| State  |  Name |
|----------|------|
|pvVinRef| pv v in ref |
|pv2VinRef| pv2 v in ref |
|mpptMonitorFlag| mppt Monitor Flag |
...
|emsMonitorFlag| ems Monitor Flag |
...
|plugInInfoAcInChgHalPowMax| plug In Info Ac In Chg Hal Pow Max |
...
|stdProtoVersion| std Proto Version |
|multiBpChgDsgMode| multi Bp Chg Dsg Mode |
|powerProtectPortSelect| power Protect Port Select |
...
|powGetTypec3|0 | 4000 | W | 1 |  Real-time power of Type-C port 3 |
...
|plugInInfoPv2ChgVolMax|0 | 61 | V | 1 |  plug in info pv2 chg vol max |
|powGetAcOut|0 | 4000 | W | 1 |  pow get ac out |
|powGetDcp|0 | 600 | W | 1 |  pow get dcp |
|powGetDcp2|0 | 600 | W | 1 |  pow get dcp2 |
...
|ac2StandbyTime| 0 | 1440 | min | 1 |  AC2 timeout (min) | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
...
|flowInfoTypec3| Type-C port 3 switch status | {0:off,2:on} |
...
|upsAlarm| ups Alarm | {0:OK?,1:error} |
|pcsFanErrFlag| pcs fan err flag | {0:OK?,1:error} |
|llcHvLvFlag| llc Hv Lv Flag | {0:OK?,1:error} |
|stormPatternConflictFlag| storm Pattern Conflict Flag | {0:OK?,1:error} |
|bypassOutDisableConflictFlag| bypass Out Disable Conflict Flag | {0:OK?,1:error} |
|updateBanFlag| update Ban Flag | {0:OK?,1:error} |
|plugInInfoPvWeakSourceFlag| plug In Info Pv Weak Source Flag | {0:OK?,1:error} |
|powerOutagesActiveFlag| power Outages Active Flag | {0:OK?,1:error} |
...
|flowInfoAc2Out| flow info ac2 out | {0:OK?} |
...
|powerOutagesList| power Outages List |
|powGet_12vList| pow Get 12v List |
|powGetAcOutList| pow Get Ac Out List |
