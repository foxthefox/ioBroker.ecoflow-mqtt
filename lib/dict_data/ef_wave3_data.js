...
const deviceStatesDict = {
    wave3: {
        ...
        DispplayPropertyUpload: {
            ...
            lcdLight: { name: 'Screen brightness', entity: 'number' },
            ...
            devStandbyTime: { name: 'Device timeout', entity: 'number' },
            screenOffTime: { name: 'Screen timeout', entity: 'number' },
            ...
            utcTimezoneId: { name: 'utc timezone id', entity: 'number' },
            ...
            plugInInfoAcInChgPowMax: { name: 'Maximum AC charging power', entity: 'number' },
            ...
            cmsMaxChgSoc: { name: 'Charge limit', entity: 'number' },
            cmsMinDsgSoc: { name: 'Discharge limit.', entity: 'number' },
            ...
            timeTaskConflictFlag: { name: 'time task conflict flag', entity: 'number' },
...
const protoMsg = {
    cmdId: {
        98: { cmdFunc: { 50: 'cmdId98_cmdfunc50_Report' } },
        22: { cmdFunc: { 254: 'RuntimePropertyUpload' } },
        21: { cmdFunc: { 254: 'DisplayPropertyUpload' } },
        // 20: {},
        19: { cmdFunc: { 254: 'cmd19_cmdfunc254_Report' } },
...
const wave3 = {
    cmdFunc: {
        50: { cmdId: { 98: "cmdId98_cmdfunc50_Report" } },
        254: {
            cmdId: {
                17: "set_dp3",
                18: "setReply_dp3",
                19: "cmd19_cmdfunc254_Report",
...
message cmdId98_cmdfunc50_Report {
    optional Status98 status = 1;
    optional int32 timestamp = 2;
    optional int32 nr3 =3;
    optional int32 nr4 = 4;
    optional int32 nr5 = 5;
}

message cmd19_cmdfunc254_Report {
    optional bytes state1 = 1;
}
...
message DisplayPropertyUpload {
   ...
   */
    ...
    optional string unknown392 = 392; //-ResvInfo?
