                    ...
                    for (let channel in payload) {
                        ...
                        switch (channel) {
                            ...
                            case 'HRChargingParamReport':
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !payload[channel]['mpptPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !payload[channel]['sysGridPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !payload[channel]['bpPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                            ...
                            case 'EnergyStreamDetail':
                                ...
                                for (let i = 0; i < payload[channel]['sysEnergyStream'].length; i++) {
                                    ...
                                    // artificial set value to 0, if datapoint is missing in telegram
                                    if (
                                        channel === 'EnergyStreamDetail' &&
                                        !payload[channel]['sysEnergyStream'][i]['mpptPwr']
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                    ...
                                    if (
                                        channel === 'EnergyStreamDetail' &&
                                        !payload[channel]['sysEnergyStream'][i]['sysGridPwr']
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                    ...
                                    if (
                                        channel === 'EnergyStreamDetail' &&
                                        !payload[channel]['sysEnergyStream'][i]['bpPwr']
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
