                    ...
                    for (let channel in payload) {
                        ...
                        switch (channel) {
                            ...
                            case 'HRChargingParamReport':
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !('mpptPwr' in payload[channel])) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !('sysGridPwr' in payload[channel])) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !('bpPwr' in payload[channel])) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                            ...
                            case 'EnergyStreamDetail':
                                ...
                                for (let i = 0; i < payload[channel]['sysEnergyStream'].length; i++) {
                                    ...
                                    if (!('mpptPwr' in payload[channel]['sysEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                    ...
                                    if (!('sysGridPwr' in payload[channel]['sysEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                    ...
                                    if (!('bpPwr' in payload[channel]['sysEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                            ...
                            case 'HeatingRodEnergyStreamShow':
                                for (let i = 0; i < payload[channel]['hrEnergyStream'].length; i++) {
                                    ...
                                    if (!('hrPwr' in payload[channel]['hrEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                    ...
                                    if (!('fromPv' in payload[channel]['hrEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                    ...
                                    if (!('fromBat' in payload[channel]['hrEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                    ...
                                    if (!('fromGrid' in payload[channel]['hrEnergyStream'][i])) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
