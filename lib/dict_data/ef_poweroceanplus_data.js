                    ...
                    for (let channel in payload) {
                        ...
                        switch (channel) {
                            ...
                            case 'HRChargingParamReport':
                                ...
                                if (
                                    channel === 'JTS1_ENERGY_STREAM_REPORT' &&
                                    !('mpptPwr' in payload[channel]) &&
                                    adapter.specialPoweroceanZero
                                ) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                            ...
                            case 'EnergyStreamDetail':
                                ...
                                if (adapter.specialPoweroceanReportFromDetail) {
                                    for (let i = 0; i < payload[channel]['sysEnergyStream'].length; i++) {
                                        ...
                                        if (
                                            !('mpptPwr' in payload[channel]['sysEnergyStream'][i]) &&
                                            adapter.specialPoweroceanZero
                                        ) {
                                            let haupd;
                                            haupd = await compareUpdate(
                                        ...
                                        if (
                                            !('sysGridPwr' in payload[channel]['sysEnergyStream'][i]) &&
                                            adapter.specialPoweroceanZero
                                        ) {
                                            let haupd;
                                            haupd = await compareUpdate(
                                        ...
                                        if (
                                            !(
                                                'bpPwr' in payload[channel]['sysEnergyStream'][i] &&
                                                adapter.specialPoweroceanZero
                                            )
                                        ) {
                                            let haupd;
                            ...
                            case 'HeatingRodEnergyStreamShow':
                                for (let i = 0; i < payload[channel]['hrEnergyStream'].length; i++) {
                                    ...
                                    if (
                                        !('hrPwr' in payload[channel]['hrEnergyStream'][i]) &&
                                        adapter.specialPoweroceanZero
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                    ...
                                    if (
                                        !('fromPv' in payload[channel]['hrEnergyStream'][i]) &&
                                        adapter.specialPoweroceanZero
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                    ...
                                    if (
                                        !('fromBat' in payload[channel]['hrEnergyStream'][i]) &&
                                        adapter.specialPoweroceanZero
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                    ...
                                    if (
                                        !('fromGrid' in payload[channel]['hrEnergyStream'][i]) &&
                                        adapter.specialPoweroceanZero
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
