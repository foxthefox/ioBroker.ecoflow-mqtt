                    ...
                    for (let channel in payload) {
                        ...
                        switch (channel) {
                            ...
                            case 'HRChargingParamReport':
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !channel['mpptPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !channel['sysGridPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
                                ...
                                if (channel === 'JTS1_ENERGY_STREAM_REPORT' && !channel['bpPwr']) {
                                    let haupd;
                                    haupd = await compareUpdate(
                                        adapter,
                                        stateDictObj,
