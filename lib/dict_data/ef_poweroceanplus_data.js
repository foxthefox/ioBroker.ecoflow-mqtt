                    ...
                    for (let channel in payload) {
                        ...
                        switch (channel) {
                            ...
                            case 'EnergyStreamDetail':
                                ...
                                for (let i = 0; i < 1; i++) {
                                    //the telegram is send after 5min and has 1 array for each minute, the first is the most current one
                                    // todo if meaningful -> store with timestamp
                                    //payload[channel]['sysEnergyStream'].length; i++) {
                                    ...
                                    if (
                                        ...
                                        adapter.log.debug(
                                            `${topic} JTS1_ENERGY_STREAM_DETAIL artificial set mpptPwr = 0`,
                                        );
                                        if (Object.keys(haupd).length !== 0) {
                                            haUpdate.push(haupd);
                                        }
                                    ...
                                    if (
                                        !('gridPwr' in payload[channel]['sysEnergyStream'][i]) &&
                                        adapter.specialPoweroceanZero
                                    ) {
                                        let haupd;
                                        haupd = await compareUpdate(
                                        ...
                                        adapter.log.debug(
                                            `${topic} JTS1_ENERGY_STREAM_DETAIL artificial set gridPwr = 0`,
                                        );
                                        if (Object.keys(haupd).length !== 0) {
                                            haUpdate.push(haupd);
                                        }
                                    ...
                                    if (
                                        ...
                                        adapter.log.debug(
                                            `${topic} JTS1_ENERGY_STREAM_DETAIL artificial set bpPwr = 0`,
                                        );
                                        if (Object.keys(haupd).length !== 0) {
                                            haUpdate.push(haupd);
                                        }
