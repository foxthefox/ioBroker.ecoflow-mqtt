const deviceStates = {
    ...
    DisplayPropertyUpload: {
        ...
        switch: {
            ...
            // custom vs silent mode (80W)
            //main ac ono/off
            //230V on/off
            // 12V on/off
            //low battery reminder

            //When on -> slider controlling both Backup reserve and Solar only simultaneously, reserve:5%(solar:55%)-reserve:60%(solar:0%), steps of 1%
        },
    },
    StatisticsSum: {
        number: {
...
message set_dp3 {
    ...
    optional int32 cfg_ac_out_open = 76; //bool
    optional uint32 cfg_led_mode = 89;

    optional .CfgEnergyBackup cfg_energy_backup = 43;
    optional int32 cfg_output_power_off_memory = 141; //bool
}
