        ...
        */
        ...
        switch (state) {
            ...
            case 'plugInInfoAcInChgPowMax':
                muster['header']['pdata'] = {};
                muster['header']['pdata'][state] = parseInt(String(value)); //int
                muster['header']['pdata']['plugInInfoAcInChgMode'] = 0; //always 0 for userdefined power level
                if (state > 128) {
...
message set_dp3 {
    ...
    optional .AC_IN_CHG_MODE plugInInfoAcInChgMode = 125;
