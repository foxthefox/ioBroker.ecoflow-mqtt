    ...
    DisplayPropertyUpload: {
        array: {
            ...
            energyStrategyOperateMode: {
                entity_type: 'text', entity_category: 'diagnostic', role: 'list', name: 'Energy Strategy Operate Mode'
            }
        },
        string: {
            ...
            selfPoweredConflictFlag: { entity_type: 'text', entity_category: 'diagnostic', name: 'Self Powered Conflict Flag', role: 'info' },
            touModeConflictFlag: { entity_type: 'text', entity_category: 'diagnostic', name: 'TOU Mode Conflict Flag', role: 'info' }
        },
        number: {
            backupReverseSoc: {
                min: 0,
...
const protoMsg = {
    cmdId: {
        ...
        50: { cmdFunc: { 32: 'BMSHeartBeatReport' } }, //battery report
