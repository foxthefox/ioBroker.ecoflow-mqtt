const poweroceanStates = {
	...
	JTS1_EMS_HEARTBEAT: {
		...
		string: {
			...
			pcsvbusref: { entity_type: 'text', entity_category: 'diagnostic', name: 'pcsvbusref', role: 'info' },
			pcsActivePowerRef: {
				entity_type: 'text',
				entity_category: 'diagnostic',
	...
	JTS1_EMS_CHANGE_REPORT: {
		...
		string: {
			...
			ppcsQuQ1: { entity_type: 'text', entity_category: 'diagnostic', name: 'ppcs qu q1', role: 'info' },
			ppcsQuQ2: { entity_type: 'text', entity_category: 'diagnostic', name: 'ppcs qu q2', role: 'info' },
			ppcsQuQ3: { entity_type: 'text', entity_category: 'diagnostic', name: 'ppcs qu q3', role: 'info' },
			ppcsQuQ4: { entity_type: 'text', entity_category: 'diagnostic', name: 'ppcs qu q4', role: 'info' },
			pcsQuTimeConst: {
				entity_type: 'text',
				entity_category: 'diagnostic',
			...
			evBindList: { entity_type: 'text', entity_category: 'diagnostic', name: 'ev bind list', role: 'info' }
		}
	},
...
const poweroceanStatesDict = {
	powerocean: {
		...
		JTS1_EMS_CHANGE_REPORT: {
			...
			pcsOverReqRecover: { entity: 'string' },
			...
			ppcsQuQ1: { entity: 'string' },
			ppcsQuQ2: { entity: 'string' },
			ppcsQuQ3: { entity: 'string' },
			ppcsQuQ4: { entity: 'string' },
...
const protoMsg = {
	cmdId: {
		...
		113: { cmdFunc: { 53: 'ModuleClusterInfo' } }, //cmd
		112: { cmdFunc: { 96: 'SysBatChgDsgSet' } },
		98: { cmdFunc: { 50: 'APP_CMD_ID_EU_LAW_ACK' } },
		97: { cmdFunc: { 96: 'EnergyStreamSwitch' } }, //cmd
		39: { cmdFunc: { 96: 'EmsPVInvEnergyStreamReport' } },
		//38: { cmdFunc: { 224: '' } },
		51: { cmdFunc: { 209: 'EVChargingRemoteListSync' } },
		37: { cmdFunc: { 96: 'EmsGetParam' } }, //
		34: { cmdFunc: { 96: 'EnergyStreamDetail' } }, //
		33: { cmdFunc: { 209: 'EVChargingEnergyStreamReport', 96: 'JTS1_ENERGY_STREAM_REPORT' } },
		32: { cmdFunc: { 254: 'unknown_32_254' } },
		13: { cmdFunc: { 96: 'JTS1_EMS_PARAM_CHANGE_REPORT' } },
		11: { cmdFunc: { 96: 'JTS1_ECOLOGY_DEV_REPORT' } },
		10: { cmdFunc: { 96: 'EmsAllTimerTaskReport' } },
		9: { cmdFunc: { 96: 'JTS1_ERROR_CODE_MASK_REPORT' } },
		8: { cmdFunc: { 209: 'EVChargingParamReport', 96: 'JTS1_EMS_CHANGE_REPORT' } },
		7: { cmdFunc: { 96: 'JTS1_BP_STA_REPORT' } },
		3: { cmdFunc: { 96: 'ErrorChangeReport' } }, // IDs von ems/pcs und den Batterien
		2: { cmdFunc: { 209: 'EVChargingTimerTaskReport', 2: 'BackendRecordHeartbeatReport' } },
		1: { cmdFunc: { 96: 'JTS1_EMS_HEARTBEAT', 224: 'EcologyDevBindListReport' } }
	}
};
...
message JTS1_EMS_HEARTBEAT {
	...
	optional LoadInfo pcsLoadInfo = 15; //flatten
...
message SysBatChgDsgSet {
	...
	optional uint32 unknown = 4; //eventuell ratio
}
...
message unknown_32_254_2 {
	 optional int32 timestamp = 1;
	 optional int32 number =2;
	 optional string string =3;
}

 message unknown_32_254 {
	optional int32 unknown1	= 1;
	repeated unknown_32_254_2 info = 2;
 }
