                            ...
                            case 'ParallelEnergyStreamDetail':
                                {
                                    ...
                                    const system1 = await adapter
                                        .getStateAsync(`${topic}.ParallelEnergyStreamDetail.system1_devSn`)
                                        .catch(e => {
                                            adapter.log.warn(
                                                `did not get ParallelEnergyStreamDetail.system1_devSn ->${e}`,
                                            );
                                        });
                                    const ocean = await adapter
                                        .getStateAsync(`${topic}.ParallelEnergyStreamDetail.ocean_devSn`)
                                        .catch(e => {
                                            adapter.log.warn(
                                                `did not get ParallelEnergyStreamDetail.system1_devSn ->${e}`,
                                            );
                                    ...
                                    if (system1 && ocean) {
                                        ...
                                        adapter.log.debug(
                                            'ParallelEnergyStreamDetail did not get system1 or ocean devSn',
                                        );
                                    }
                                }
                                break;
