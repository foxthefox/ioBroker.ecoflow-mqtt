...
const deviceStatesDict = {
    powerocean: {
        ...
        ParallelEnergyStreamReport: {
            ...
            bpPwr: { entity: 'number' },
            bpSoc: { entity: 'number' },
            unknown9: { entity: 'number' },
            unknown10: { entity: 'number' },
            ...
            ocean_unknown9: { entity: 'number' },
            ocean_unknown10: { entity: 'number' },
            ...
            system1_unknown9: { entity: 'number' },
            system1_unknown10: { entity: 'number' },
        },
        JTS1_EMS_HEARTBEAT: {
...
const protoMsg = {
    cmdId: {
        //146: { cmdFunc: { 96: 'SysLedBrightSet' } }, //146 seems not to be LED brightness
        127: { cmdFunc: { 96: 'EmsAllTimerTaskGet' } },
        119: { cmdFunc: { 96: 'SysLedBrightSet' } }, // "src":32,"dest":96, SYS_CTRL_LED
        113: { cmdFunc: { 53: 'ModuleClusterInfo' } }, //cmd // ??? IOT_CMD_ID_MODULE_INFO
        112: { cmdFunc: { 96: 'SysBatChgDsgSet' } }, //->todo
        98: { cmdFunc: { 50: 'AppRuquestBpEuLawDataAck' } }, // APP_CMD_ID_EU_LAW_ACK 		AppRuquestBpEuLawData src/dst unterschiedlich
        97: { cmdFunc: { 96: 'EnergyStreamSwitch' } }, //cmd
        51: { cmdFunc: { 96: 'ParallelEnergyStreamDetail', 209: 'EVChargingRemoteListSync' } },
        50: { cmdFunc: { 96: 'ParallelEnergyStreamReport', 212: 'HeatingRodRunDataAck' } },
        48: { cmdFunc: { 212: 'HeatingRodCtrl' } },
        39: { cmdFunc: { 96: 'EmsPVInvEnergyStreamReport' } },
        //38: { cmdFunc: { 224: '' } },
        37: { cmdFunc: { 96: 'EmsGetParam', 224: 'id37func224' } }, //
        34: { cmdFunc: { 96: 'EnergyStreamDetail', 212: 'HeatingRodStreamDetail' } }, //
        33: {
            cmdFunc: {
                209: 'EVChargingEnergyStreamReport',
                96: 'JTS1_ENERGY_STREAM_REPORT',
                212: 'HeatingRodEnergyStreamShow',
            },
        },
        32: { cmdFunc: { 254: 'EnergyTotalReport' } }, //->todo
        13: { cmdFunc: { 96: 'JTS1_EMS_PARAM_CHANGE_REPORT' } },
        12: { cmdFunc: { 96: 'ParallelDevList' } },
        11: { cmdFunc: { 96: 'EmsEcologyDevReport' } }, //EmsEcologyDevReport JTS1_ECOLOGY_DEV_REPORT
        10: { cmdFunc: { 96: 'EmsAllTimerTaskReport' } },
        9: { cmdFunc: { 96: 'JTS1_ERROR_CODE_MASK_REPORT' } },
        8: { cmdFunc: { 209: 'EVChargingParamReport', 96: 'JTS1_EMS_CHANGE_REPORT', 212: 'HRChargingParamReport' } },
        7: { cmdFunc: { 96: 'JTS1_BP_STA_REPORT' } },
        //5: { cmdFunc: { 241: 'id5func241' } },
        3: { cmdFunc: { 96: 'ErrorChangeReport', 241: 'EDevParamReport' } }, // IDs von ems/pcs und den Batterien
        2: {
            cmdFunc: {
                209: 'EVChargingTimerTaskReport',
                2: 'BackendRecordHeartbeatReport',
                212: 'HeatingRodTimerTaskReport',
                240: 'EDevPriorityListReport',
            },
        }, //240: 'id2func240'
        1: { cmdFunc: { 96: 'JTS1_EMS_HEARTBEAT', 224: 'EcologyDevBindListReport', 241: 'EDevBindListReport' } },
    },
};
/*
const powerocean = {
	cmdFunc: {
		...
		96: {
			cmdId: {
                ...
                12: 'ParallelDevList', //not implemented  same as #43? also as MASTER_SLAVE_DEV_LIST_REPORT
                    ...
                    switch (channel) {
                        ...
                        case 'ParallelEnergyStreamReport':
                            ...
                            for (let i = 0; i < payload[channel]['paraEnergyStream'].length; i++) {
                                for (let obj in payload[channel]['paraEnergyStream'][i]) {
                                    for (let state in payload[channel]['paraEnergyStream'][i][obj]) {
                                        let val;
                                        let haupd;
                                        let prefix = '';
                                        if (i === 1) {
                                        ...
                                        val = payload[channel]['paraEnergyStream'][i][obj][state];
                                        haupd = await compareUpdate(
                                            adapter,
                                            stateDictObj,
                                            stateObj,
...
message setValue {
    ...
    message sentProtoTime {
        setHeader1 header = 1;
    }
    message sentProtoTimeStat {
        setHeader2 header = 1;
    }
    ...
    message sentProtoPushAndSet {
        setHeader4 header = 1;
    } 

    message sentStatisticsTotalReport {
        setHeader5 header = 1;
    } 

 message setHeader5 {
    StatisticsTotalReport pdata = 1;
    int32 src = 2;
    int32 dest = 3;
    int32 d_src = 4;
    int32 d_dest = 5;
