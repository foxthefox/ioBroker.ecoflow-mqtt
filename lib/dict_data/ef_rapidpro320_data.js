...
async function prepareProtoCmd(adapter, serial, streamType, state, value, cmd, log) {
    ...
    switch (state) {
        case 'typec1PortEnable':
        case 'typec2PortEnable':
        case 'typec3PortEnable':
        case 'typec4PortEnable':
        case 'pogopinPortEnable':
            muster['header']['pdata'] = {};
            muster['header']['pdata'][state] = value ? 1 : 2;
...
message ConfigWrite {
  ...
  optional uint32 typec1_port_enable = 176;
  optional uint32 typec2_port_enable = 177;
  optional uint32 typec3_port_enable = 178;
  optional uint32 typec4_port_enable = 179;
  //optional uint32 cfg_usb1_port_enable = 180;
  optional uint32 pogopin_port_enable = 181;
