...
const deviceStatesDict = {
    panel2: {
        ProtoTime: {
            ...
            bkpChWatt: { entity: 'array' }, //noch in einzelne Datenpunkte auflösen?!
            ...
            wattInfoChWatt1: { entity: 'number' },
            wattInfoChWatt2: { entity: 'number' },
            wattInfoChWatt3: { entity: 'number' },
...
const protoMsg = {
    cmdFunc: {
        ...
        2: { cmdId: { 1: 'ProtoTime' } },
        12: {
            cmdId: { 1: 'ProtoTimeStat', 32: 'ProtoPushAndSet', 33: 'shp2cmd' },
        },
        254: {
            cmdId: { 21: 'DisplayPropertyUpload', 32: 'StatisticsTotalReport' },
        },
    },
};

const msgNameObj = {
    ProtoTime: { cmdId: 1, cmdFunc: 2 },
    ProtoTimeStat: { cmdId: 1, cmdFunc: 12 },
    ProtoPushAndSet: { cmdId: 32, cmdFunc: 12 },
    StatisticsTotalReport: { cmdId: 32, cmdFunc: 254 },
                                    ...
                                    switch (state) {
                                        ...
                                        case 'wattInfo':
                                            ...
                                            if (
                                                ...
                                                for (
                                                    let i = 0;
                                                    i < payload[channel]['wattInfo']['chWatt'].length;
                                                    i++
                                                ) {
                                                ...
                                                if (
                                                    ...
                                                    for (let i = 0; i < 12; i++) {
                                                        if (payload[channel][state]['hall1ChInfo'][i]['loadIsEnable']) {
                                                            val =
                                                                payload[channel][state]['hall1ChInfo'][i][
                                                                    'loadIsEnable'
                                                                ];
                                                            haupd = await compareUpdate(
                                                                adapter,
                                        ...
                                        case 'backupIncreInfo':
                                            for (let neststate in payload[channel][state]) {
                                                ...
                                                if (
                                                    ...
                                                    neststate === 'DeltaPro1Info' ||
                                                    neststate === 'DeltaPro2Info'
                                                ) {
                                                    for (let dp in payload[channel][state][neststate]) {
                                                        let val;
                                                        let haupd;
                                        ...
                                        case 'loadIncreInfo':
                                            for (let neststate in payload[channel][state]['hall1IncreInfo']) {
                                                ...
                                                if (
                                                    ...
                                                    for (let dp in payload[channel][state]['hall1IncreInfo'][
                                                        neststate
                                                    ]) {
                                                        if (dp === 'splitphase') {
                                                            if (
                                                                Object.prototype.hasOwnProperty.call(
                                                                    payload[channel][state]['hall1IncreInfo'][
                                                                        neststate
                                                                    ][dp],
                                                                    'linkMark',
                                                                )
...
message timestampPlus {
	optional int32 timestamp = 1;
	optional int32 unknownTS = 2;
}

message ProtoTimeStat {
	...
	optional timestampPlus  timestampPlus  = 200;
}
...
message shp2cmd
{
  ...
  optional uint32 ch2_enable_set = 25; //AC2 1=ON, 2=OFF
...
message LoadChInfo 
{
    ...
    optional int32 load_sta = 7; //LOAD_CH_STA
    optional int32 ctrl_mode = 8; //CTRL_MODE
}

message LoadChaSta
{
	optional int32 load_sta = 1; //LOAD_CH_STA
	optional int32 ctrl_mode = 2; //CTRL_MODE
...
message BackupChannelInfo
{
	...
	optional int32 force_charge_sta = 3; //FORCE_CHARGE_STA
...
message ProtoPushAndSet
{
	...
	optional int32 product_type = 3; //PRODUCT_TYPE
	...
	optional int32 power_sta = 9; //POWER_STA
	...
	optional int32 ch1_force_charge = 18; //FORCE_CHARGE_STA
	optional int32 ch2_force_charge = 19; //FORCE_CHARGE_STA
	optional int32 ch3_force_charge = 20; //FORCE_CHARGE_STA
...
message MasterToBackProtoPushAndSet
{
	...
	optional int32 grid_status = 4; //GRID_STATUS
	...
	optional int32 ch1_force_charge = 50; //FORCE_CHARGE_STA
	optional int32 ch2_force_charge = 51; //FORCE_CHARGE_STA
	optional int32 ch3_force_charge = 52; //FORCE_CHARGE_STA
