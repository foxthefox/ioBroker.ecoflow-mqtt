    ...
    RuntimePropertyUpload: {
        ...
        string: {
            ...
            emsMonitorFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'ems Monitor Flag',
                role: 'info',
            },
            invMainFsmstate: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'inv Main Fsm state',
                role: 'info',
            },
            llcFsmstate: {
                entity_type: 'text',
        ...
        array: {
            ...
            plugInInfo_12vAmpList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'list',
                name: '12V amp list',
            },
            plugInInfoAcOutAmpList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'list',
                name: 'Ac Out Amp List',
            },
        },
    },
    DisplayPropertyUpload: {
        array: {
            ...
            powerOutagesList: {
                ...
                entity_category: 'diagnostic',
                role: 'list',
                name: 'power Outages List',
            },
            powGet_12vList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'list',
                name: 'pow Get 12v List',
            },
            powGetAcOutList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'list',
                name: 'pow Get Ac Out List',
            },
            timezoneChangeList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
        ...
        string: {
            ...
            powerProtectPortSelect: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'power Protect Port Select',
                role: 'info',
            },
        },
        number: {
            ...
            powGetTypec3: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'Real-time power of Type-C port 3',
                subrole: 'number',
            },
            powGet_12v: {
                min: 0,
        ...
        diagnostic: {
            ...
            flowInfoTypec3: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'Type-C port 3 switch status',
                role: 'info',
                flowInfoTypec3: { 0: 'off', 2: 'on' },
            },
            flowInfo_12v: {
                entity_type: 'text',
                entity_category: 'diagnostic',
            ...
            llcHvLvFlag: {
                ...
                name: 'llc Hv Lv Flag',
                role: 'info',
                llcHvLvFlag: { 0: 'OK?', 1: 'error' },
            },
            stormPatternConflictFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'storm Pattern Conflict Flag',
                role: 'info',
                stormPatternConflictFlag: { 0: 'OK?', 1: 'error' },
            },
            bypassOutDisableConflictFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'bypass Out Disable Conflict Flag',
                role: 'info',
                bypassOutDisableConflictFlag: { 0: 'OK?', 1: 'error' },
            },
            updateBanFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                ...
                role: 'info',
                updateBanFlag: { 0: 'OK?', 1: 'error' },
            },
            plugInInfoPvWeakSourceFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'plug In Info Pv Weak Source Flag',
                role: 'info',
                plugInInfoPvWeakSourceFlag: { 0: 'OK?', 1: 'error' },
            },
            powerOutagesActiveFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'power Outages Active Flag',
                role: 'info',
                powerOutagesActiveFlag: { 0: 'OK?', 1: 'error' },
            },
            plugInInfoAcOutDsgPowMax: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                ...
                role: 'info',
                plugInInfoAcOutDsgPowMax: { 0: 'OK?', 1: 'error' },
            },
            cmsBmsRunState: {
                entity_type: 'text',
                entity_category: 'diagnostic',
...
const deviceStatesDict = {
    delta3classic: {
        RuntimePropertyUpload: {
            ...
            plugInInfoDcp2Amp: { entity: 'number' },
            plugInInfoDcp2Vol: { entity: 'number' },
            ...
            plugInInfo_12vAmpList: { entity: 'array' },
            plugInInfoAcOutAmpList: { entity: 'array' },
            dcdcChgReqCur: { entity: 'number' },
            plugInInfoPfcOutVol: { entity: 'number' },
            pvVinRef: { entity: 'string' },
            pv2VinRef: { entity: 'string' },
            tempList: { entity: 'array' },
            tempPv2: { entity: 'number' },
            plugInInfoPv2Vol: { entity: 'number' },
            llcRecvCmsChgReqVol: { entity: 'number' },
            mpptMonitorFlag: { entity: 'string' },
            invMonitorFlag: { entity: 'string' },
            invMainFsmstate: { entity: 'string' },
            llcMonitorFlag: { entity: 'string' },
            llcFsmstate: { entity: 'string' },
            emsMonitorFlag: { entity: 'string' },
        ...
        DisplayPropertyUpload: {
            ...
            plugInInfoAcInChgHalPowMax: { entity: 'string' },
            ...
            powerOutagesList: { entity: 'array' },
            powGet_12vList: { entity: 'array' },
            powGetAcOutList: { entity: 'array' },
            timezoneChangeList: { entity: 'array' },
            upsAlarm: { entity: 'diagnostic' },
            pcsFanErrFlag: { entity: 'diagnostic' },
            llcHvLvFlag: { entity: 'diagnostic' },
            stormPatternConflictFlag: { entity: 'diagnostic' },
            bypassOutDisableConflictFlag: { entity: 'diagnostic' },
            updateBanFlag: { entity: 'diagnostic' },
            plugInInfoPvWeakSourceFlag: { entity: 'diagnostic' },
            powerOutagesActiveFlag: { entity: 'diagnostic' },
            ...
            flowInfoAc2Out: { entity: 'diagnostic' },
            ...
            stdProtoVersion: { entity: 'string' },
            multiBpChgDsgMode: { entity: 'string' },
            powerProtectPortSelect: { entity: 'string' },
        },
        BMSHeartBeatReport: {
            num: { entity: 'string' },
            type: { entity: 'string' },
...
const deviceCmd = {
    delta3classic: {
        DisplayPropertyUpload: {
            ...
            ac2StandbyTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }, //oder Länge 4
...
message WirelessCoordinateList {
  optional int32 connect_flag = 1; //bool
...
message SetTimeTaskWrite {
  ...
  optional int32 is_valid = 2; //bool
  optional int32 is_cfg = 3; //bool
  optional int32 is_enable = 4; //bool
...
message DisplayPropertyUpload { 
   ...
   optional int32 energy_backup_en = 7; //bool
   ...
   optional int32 xboost_en = 25; //bool
   ...
   optional int32 utc_set_mode = 135; //bool
   ...
   optional uint32 bms_err_code = 140;
    ...
    optional int32 wireless_oil_self_start = 143; //bool
    optional uint32 wireless_oil_on_soc = 144;
    optional uint32 wireless_oil_off_soc = 145;
    optional int32 bypass_out_disable = 146; //bool
   optional int32 output_power_off_memory = 147; //bool
   ...
   optional int32 en_beep = 195; //bool
...
message CfgEnergyStrategyOperateMode {
  optional int32 operate_self_powered_open = 1; //bool
  optional int32 operate_scheduled_open = 2; //bool
  optional int32 operate_tou_mode_open = 3; //bool
}
...
message ConfigWrite {
    ...
    optional int32 cfg_bypass_out_disable = 26; //bool
