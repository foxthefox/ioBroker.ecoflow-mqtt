    ...
    RuntimePropertyUpload: {
        number: {
            ...
            cascadeSysDeviceCnt: {
                ...
                entity_type: 'sensor',
                role: 'value',
                name: 'cascade sys device cnt',
                subrole: 'number',
            },
            cascadeSysDistributedPwrSum: {
                min: -2000,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'cascade sys distributed pwr sum',
                subrole: 'number',
            },
            cascadeSysOutputPwrDiff: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'cascade sys output pwr diff',
                subrole: 'number',
            },
            dev1DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'dev1 distribute target',
                subrole: 'number',
            },
            dev2DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'dev2 distribute target',
                subrole: 'number',
            },
            dev3DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'dev3 distribute target',
                subrole: 'number',
            },
            dev4DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'dev4 distribute target',
                subrole: 'number',
            },
            dev5DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'dev5 distribute target',
                subrole: 'number',
            },
            dev6DistributeTarget: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
            ...
            curAvaiToBmsPower: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'cur avai to bms power',
                subrole: 'number',
            },
            invInPowerAbilityMax: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'inv in power ability max',
                subrole: 'number',
            },
            invOutPowerAbilityMax: {
                min: 0,
                max: 2000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'inv out power ability max',
                subrole: 'number',
            },
            ongridOutPowerAbilityMax: {
                min: 0,
                max: 3000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'ongrid out power ability max',
                subrole: 'number',
            },
            bypassOutPowerAbilityMax: {
                min: 0,
                max: 3000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'bypass out power ability max',
                subrole: 'number',
            },
            vBusHv: {
                min: 0,
            ...
            ongridInActivePower: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'ongrid in active power',
                subrole: 'number',
            },
            ongridInReactivePower: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
            ...
            offgrid1ApperentPower: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'offgrid1 apperent power',
                subrole: 'number',
            },
            offgrid2ApperentPower: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'offgrid2 apperent power',
                subrole: 'number',
            },
            offgridInvDeratePower: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'offgrid inv derate power',
                subrole: 'number',
            },
            ongridInvDeratePower: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'ongrid inv derate power',
                subrole: 'number',
            },
            acTotalInvDeratePower: {
                min: 0,
                max: 6000,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'ac total inv derate power',
                subrole: 'number',
            },
            mosVolt: {
                min: 0,
            ...
            actPwrByOvdp: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'act pwr by ovdp',
                subrole: 'number',
            },
            ongridActivePowerRef: {
                min: 0,
                max: 2500,
                unit_of_measurement: 'W',
                mult: 1,
        ...
        string: {
            ...
            lanSysMeterValue: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'lan sys meter value',
                role: 'info',
            },
            cascadeSysCanId: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'cascade sys can id',
                role: 'info',
            },
            pv1InsRx: {
                entity_type: 'text',
            ...
            emsPfcChgPwrTag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'ems pfc chg pwr tag',
                role: 'info',
            },
            chgPowerLoopRef: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'chg power loop ref',
                role: 'info',
            },
            iDabLv: {
                entity_type: 'text',
            ...
            pvStateMonitor1: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'pv state monitor1',
                role: 'info',
            },
            pvStateMonitor2: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'pv state monitor2',
                role: 'info',
            },
            dabStateMonitor1: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dab state monitor1',
                role: 'info',
            },
            dabStateMonitor2: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dab state monitor2',
                role: 'info',
            },
            dabStateMonitor3: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dab state monitor3',
                role: 'info',
            },
        },
        diagnostic: {
            ...
            cascadeSysWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'cascade sys work mode',
                role: 'info',
                cascadeSysWorkMode: { 0: 'OK?' },
            },
            dev1ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev1 to pcs work mode',
                role: 'info',
                dev1ToPcsWorkMode: { 0: 'OK?' },
            },
            dev2ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev2 to pcs work mode',
                role: 'info',
                dev2ToPcsWorkMode: { 0: 'OK?' },
            },
            dev3ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev3 to pcs work mode',
                role: 'info',
                dev3ToPcsWorkMode: { 0: 'OK?' },
            },
            dev4ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev4 to pcs work mode',
                role: 'info',
                dev4ToPcsWorkMode: { 0: 'OK?' },
            },
            dev5ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev5 to pcs work mode',
                role: 'info',
                dev5ToPcsWorkMode: { 0: 'OK?' },
            },
            dev6ToPcsWorkMode: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'dev6 to pcs work mode',
                role: 'info',
                dev6ToPcsWorkMode: { 0: 'OK?' },
            },
            mpptFaultComm: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'mppt fault comm',
                role: 'info',
                mpptFaultComm: { 0: 'OK?' },
            },
            mpptPv1Fault: {
            ...
            invStateMonitor1: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'inv state monitor1',
                role: 'info',
                invStateMonitor1: { 0: 'OK?' },
            },
            invStateMonitor2: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'inv state monitor2',
                role: 'info',
                invStateMonitor2: { 0: 'OK?' },
            },
            invStateMonitor3: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'inv state monitor3',
                role: 'info',
                invStateMonitor3: { 0: 'OK?' },
            },
            invFault: {
                entity_type: 'text',
                entity_category: 'diagnostic',
        ...
        array: {
            lanSysScheduleOutput: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'list',
                name: 'lan sys schedule output',
            },
        },
    },
    DisplayPropertyUpload: {
        ...
        number: {
            ...
            sysGridInPwrLimit: {
                ...
                device_class: 'power',
                role: 'value',
                name: 'sys Grid In Pwr Limit',
                subrole: 'number',
            },
            feedGridSafetyPowMax: {
                min: 0,
                max: 2300,
                unit_of_measurement: 'W',
                mult: 1,
                ...
                device_class: 'power',
                role: 'value',
                name: 'feed Grid Safety Power Max',
                subrole: 'number',
            },
        },
        string: {
            ...
            socket1BindDeviceSn: {
                ...
                entity_category: 'diagnostic',
                role: 'info',
                name: 'socket1 Bind Device Sn',
            },
            socket2BindDeviceSn: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'info',
                name: 'socket2 Bind Device Sn',
            },
            socket1PwrInUnbind: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'info',
                name: 'socket1 Pwr In Unbind',
            },
            socket2PwrInUnbind: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                role: 'info',
                name: 'socket2 Pwr In Unbind',
            },
            pcsSerialNumber: {
                entity_type: 'text',
                entity_category: 'diagnostic',
        ...
        array: {
            ...
            allTimerTask: { entity_type: 'text', entity_category: 'diagnostic', name: 'all timer task', role: 'list' },
            controllableLoadList: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'Controllable Load List',
                role: 'list',
            },
            gridConnectionPortBind: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'grid Connection Port Bind',
                role: 'list',
            },
        },
    },
...
const deviceStatesDict = {
    stream_ultra_x: {
        RuntimePropertyUpload: {
            ...
            lanSysHomeNeedPwr: { entity: 'number' },
            lanSysMeterValue: { entity: 'string' },
            aiTouValid: { entity: 'diagnostic' },
            aiTouTargetSoc: { entity: 'number' },
            lanSysDeviceCnt: { entity: 'number' },
            lanSysWorkMode: { entity: 'diagnostic' },
            lanSysTargetPwr: { entity: 'number' },
            lanSysScheduleOutput: { entity: 'array' },
            cascadeSysWorkMode: { entity: 'diagnostic' },
            cascadeSysTargetPwr: { entity: 'number' },
            cascadeSysSoc: { entity: 'number' },
            cascadeSysDeviceCnt: { entity: 'number' },
            cascadeSysCanId: { entity: 'string' },
            cascadeSysDistributedPwrSum: { entity: 'number' },
            cascadeSysOutputPwrDiff: { entity: 'number' },
            dev1DistributeTarget: { entity: 'number' },
            dev2DistributeTarget: { entity: 'number' },
            dev3DistributeTarget: { entity: 'number' },
            dev4DistributeTarget: { entity: 'number' },
            dev5DistributeTarget: { entity: 'number' },
            dev6DistributeTarget: { entity: 'number' },
            dev1ToPcsWorkMode: { entity: 'diagnostic' },
            dev2ToPcsWorkMode: { entity: 'diagnostic' },
            dev3ToPcsWorkMode: { entity: 'diagnostic' },
            dev4ToPcsWorkMode: { entity: 'diagnostic' },
            dev5ToPcsWorkMode: { entity: 'diagnostic' },
            dev6ToPcsWorkMode: { entity: 'diagnostic' },
            dev1ToPcsPwr: { entity: 'number' },
            dev2ToPcsPwr: { entity: 'number' },
            dev3ToPcsPwr: { entity: 'number' },
            dev4ToPcsPwr: { entity: 'number' },
            dev5ToPcsPwr: { entity: 'number' },
            dev6ToPcsPwr: { entity: 'number' },
            dev1PvRemain: { entity: 'number' },
            dev2PvRemain: { entity: 'number' },
            dev3PvRemain: { entity: 'number' },
            dev4PvRemain: { entity: 'number' },
            dev5PvRemain: { entity: 'number' },
            dev6PvRemain: { entity: 'number' },
            dev1PowerAbility: { entity: 'number' },
            dev2PowerAbility: { entity: 'number' },
            dev3PowerAbility: { entity: 'number' },
            dev4PowerAbility: { entity: 'number' },
            dev5PowerAbility: { entity: 'number' },
            dev6PowerAbility: { entity: 'number' },
            dev1PowerInAbility: { entity: 'number' },
            dev2PowerInAbility: { entity: 'number' },
            dev3PowerInAbility: { entity: 'number' },
            dev4PowerInAbility: { entity: 'number' },
            dev5PowerInAbility: { entity: 'number' },
            dev6PowerInAbility: { entity: 'number' },
            pvStateMonitor1: { entity: 'string' },
            pvStateMonitor2: { entity: 'string' },
            dabStateMonitor1: { entity: 'string' },
            dabStateMonitor2: { entity: 'string' },
            dabStateMonitor3: { entity: 'string' },
            mpptFaultComm: { entity: 'diagnostic' },
            mpptPv1Fault: { entity: 'diagnostic' },
            mpptPv2Fault: { entity: 'diagnostic' },
            mpptPv3Fault: { entity: 'diagnostic' },
            mpptPv4Fault: { entity: 'diagnostic' },
            chgOverCurOffCnt: { entity: 'number' },
            pv1InsRx: { entity: 'string' },
            pv2InsRx: { entity: 'string' },
            pv3InsRx: { entity: 'string' },
            pv4InsRx: { entity: 'string' },
            pv1GndInsRy: { entity: 'string' },
            pv2GndInsRy: { entity: 'string' },
            pv3GndInsRy: { entity: 'string' },
            pv4GndInsRy: { entity: 'string' },
            vinPv1: { entity: 'number' },
            vinPv2: { entity: 'number' },
            vinPv3: { entity: 'number' },
            vinPv4: { entity: 'number' },
            iinPv1: { entity: 'number' },
            iinPv2: { entity: 'number' },
            iinPv3: { entity: 'number' },
            iinPv4: { entity: 'number' },
            pinPv1: { entity: 'number' },
            pinPv2: { entity: 'number' },
            pinPv3: { entity: 'number' },
            pinPv4: { entity: 'number' },
            invTodcData: { entity: 'string' },
            dcToInvData: { entity: 'string' },
            dabFault: { entity: 'diagnostic' },
            dabFaultLock: { entity: 'diagnostic' },
            emsPfcChgPwrTag: { entity: 'string' },
            chgPowerLoopRef: { entity: 'string' },
            bmsChgReqVolt: { entity: 'number' },
            bmsChgReqCurr: { entity: 'number' },
            curAvaiToBmsPower: { entity: 'number' },
            invInPowerAbilityMax: { entity: 'number' },
            invOutPowerAbilityMax: { entity: 'number' },
            ongridOutPowerAbilityMax: { entity: 'number' },
            bypassOutPowerAbilityMax: { entity: 'number' },
            vBusHv: { entity: 'number' },
            vBat: { entity: 'number' },
            ioutBat: { entity: 'number' },
            iDabLv: { entity: 'string' },
            vBusPidRef: { entity: 'number' },
            exPsD1: { entity: 'string' },
            pvIoutFilt: { entity: 'string' },
            dcTemp1Ntc: { entity: 'number' },
            dcTemp2Ntc: { entity: 'number' },
            dcTemp3Ntc: { entity: 'number' },
            dabLvTempNtc: { entity: 'number' },
            ref1P65: { entity: 'string' },
            ref2P5: { entity: 'string' },
            invStateMonitor1: { entity: 'diagnostic' },
            invStateMonitor2: { entity: 'diagnostic' },
            invStateMonitor3: { entity: 'diagnostic' },
            invFault: { entity: 'diagnostic' },
            invFaultLock: { entity: 'diagnostic' },
            pfcFault: { entity: 'diagnostic' },
            invCommFault: { entity: 'diagnostic' },
            gridFault: { entity: 'diagnostic' },
            invIl1Rms: { entity: 'number' },
            ongridIinRms: { entity: 'number' },
            dcvFilt: { entity: 'string' },
            dciFilt: { entity: 'string' },
            vBus: { entity: 'number' },
            ongridVinRms: { entity: 'number' },
            ongridVoutRms: { entity: 'number' },
            offgridVout1Rms: { entity: 'number' },
            offgridVout2Rms: { entity: 'number' },
            invVcapRms: { entity: 'number' },
            acTotalActivePower: { entity: 'number' },
            ongridInActivePower: { entity: 'number' },
            ongridInReactivePower: { entity: 'number' },
            offgrid1ActivePower: { entity: 'number' },
            offgrid2ActivePower: { entity: 'number' },
            seriesPower: { entity: 'number' },
            offgrid1ApperentPower: { entity: 'number' },
            offgrid2ApperentPower: { entity: 'number' },
            offgridInvDeratePower: { entity: 'number' },
            ongridInvDeratePower: { entity: 'number' },
            acTotalInvDeratePower: { entity: 'number' },
            mosVolt: { entity: 'number' },
            reactPwrRefDelta: { entity: 'number' },
            addPwrActLimit: { entity: 'number' },
            voltFreqfilter: { entity: 'string' },
            invTempNtc: { entity: 'number' },
            dabHighTempNtc: { entity: 'number' },
            emsSetRatedPower: { entity: 'number' },
            actPwrRated: { entity: 'number' },
            activePowerNeed: { entity: 'number' },
            actPwrByPerc: { entity: 'number' },
            actPwrByRampUp: { entity: 'number' },
            actPwrByOfdp: { entity: 'number' },
            actPwrByUfip: { entity: 'number' },
            actPwrByFreqDroop: { entity: 'number' },
            actPwrByOvdp: { entity: 'number' },
            ongridActivePowerRef: { entity: 'number' },
            pfcVbusTag: { entity: 'string' },
        },
        dayResidentLoadList: {
            startMin1: { entity: 'number' },
            endMin1: { entity: 'number' },
            loadPower1: { entity: 'level' },
        },
        DisplayPropertyUpload: {
            ...
            useLanMeter: { entity: 'diagnostic' },
            gridConnectionPortBind: { entity: 'array' },
            socket1BindDeviceSn: { entity: 'string' },
            socket2BindDeviceSn: { entity: 'string' },
            sysOffgrid: { entity: 'diagnostic' },
            sysGridInPwrLimit: { entity: 'number' },
            socket1PwrInUnbind: { entity: 'string' },
            socket2PwrInUnbind: { entity: 'string' },
            feedGridSafetyPowMax: { entity: 'number' },
            controllableLoadList: { entity: 'array' },
            pcsSerialNumber: { entity: 'string' },
            allTimerTask: { entity: 'array' },
        },
        BMSHeartBeatReport: {
            num: { entity: 'string' },
            type: { entity: 'string' },
        ...
        dayResidentLoadList: {
            loadPower1: {
                msg: {
                    ...
                    pdata: {
                        cfgUtcTime: 6,
                        cfg_feed_grid_mode_pow_limit: 169,
                        cfg_day_resident_load_list: { startMin: 1, endMin: 2, loadPower: 3 },
                    },
                },
            },
        },
                            ...
                            case 'BMSHeartBeatReport':
                                ...
                                for (let state in payload[channel]) {
                                    ...
                                    switch (state) {
                                        ...
                                        */
                                            break;
                                        case 'dayResidentLoadList':
                                            if (payload[channel][state]['load']) {
                                                if (payload[channel][state]['load'].length > 0) {
                                                    for (let i = 0; i < 1; i++) {
                                                        //only one command < payload[channel][state].length
                                                        if (payload[channel][state]['load'][i]) {
                                                            for (let item in payload[channel][state]['load'][i]) {
                                                                val = payload[channel][state]['load'][i][item];
                                                                haupd = await compareUpdate(
                                                                    adapter,
                                                                    stateDictObj,
                                                                    stateObj,
...
async function prepareProtoCmd(adapter, serial, streamType, state, value, cmd, log) {
    ...
    switch (state) {
        ...
        case 'loadPower1':
            {
                const feedGridModePowLimit = await adapter
                    .getStateAsync(`${serial}.DisplayPropertyUpload.feedGridModePowLimit`)
                    .catch(e => {
                        adapter.log.warn(`did not get ${serial}.DisplayPropertyUpload.feedGridModePowLimit ->${e}`);
                    });
                const startMin = await adapter.getStateAsync(`${serial}.dayResidentLoadList.startMin1`).catch(e => {
                    adapter.log.warn(`did not get ${serial}.dayResidentLoadList.startMin1 ->${e}`);
                });
                const endMin = await adapter.getStateAsync(`${serial}.dayResidentLoadList.endMin1`).catch(e => {
                    adapter.log.warn(`did not get ${serial}.dayResidentLoadList.endMin1 ->${e}`);
                });
                muster['header']['pdata'] = {};
                muster['header']['pdata']['cfgUtcTime'] = timestamp;
                let datalen = 6;
                muster['header']['pdata']['feedGridModePowLimit'] = parseInt(feedGridModePowLimit.val); //int
                if (feedGridModePowLimit.val > 127) {
                    datalen = datalen + 4;
                } else {
                    datalen = datalen + 3;
                }
                muster['header']['pdata']['dayResidentLoadList'] = {};
                datalen = datalen + 5; // id 379
                //30 93 a3c 0c5 06 //c8 0a a0 06 //da 17 070a05 10d005 1832
                //30c3a2c0c506c80aa006 da 17 0a0a08 08d005 10d005 1832
                //30d8f08ac506c80aa006 da 17 080a06 08d005 10d005
                //308eed8ac506c80aa006 da 17 0b0a09 08d005 10d005 18c203
                let load = {};
                if (startMin) {
                    load['startMin'] = parseInt(startMin.val); //int
                    if (startMin.val > 127) {
                        datalen = datalen + 3;
                    } else {
                        datalen = datalen + 2;
                ...
                if (endMin) {
                    load['endMin'] = parseInt(endMin.val); //int
                    if (endMin.val > 127) {
                        datalen = datalen + 3;
                    } else {
                        datalen = datalen + 2;
                ...
                if (parseInt(value) > 0) {
                    load['loadPower'] = parseInt(value); //int
                ...
                muster['header']['pdata']['dayResidentLoadList']['load'] = [];
                muster['header']['pdata']['dayResidentLoadList']['load'].push(load);
                muster['header']['dataLen'] = datalen;
            }
            break;
...
message RuntimePropertyUpload {
   ...
   optional int32 runtime_property_incremental_upload_period = 296;
    ...
    optional uint32 ai_tou_valid = 1068; //bool
...
message DeviceTargetSoc {
  string sn = 1;
  uint32 target_soc = 2;
  uint32 chg_from_grid_power_limited = 3;
}
...
message AllTimerTask {
  repeated TimerTask time_task = 1;
}
...
message DisplayPropertyUpload {
   ...
   optional AllTimerTask all_timer_task = 584;
   ...
   optional uint32 series_connect_device_id = 1285;
    optional uint32 use_lan_meter = 1292; //bool
    optional gridConnectionPortBind grid_connection_port_bind = 1293;
    optional string socket1_bind_device_sn = 1294;
    optional string socket2_bind_device_sn = 1295;
    optional uint32 sys_offgrid = 1296; //bool
    optional uint32 sys_grid_in_pwr_limit = 1495;
    optional uint32 socket1_pwr_in_unbind = 1496; //bool
    optional uint32 socket2_pwr_in_unbind = 1497; //bool
    optional uint32 feed_grid_safety_pow_max = 1543;
    optional ControllableLoadList controllable_load_list = 1549;
}
...
message ConfigWrite {
  ...
  optional uint32 feed_grid_mode_pow_limit = 169; //ac
  optional DayResidentLoadList day_resident_load_list = 379;
  ...
  optional string socket1_bind_device_sn = 565;
  optional string socket2_bind_device_sn = 566;
}
