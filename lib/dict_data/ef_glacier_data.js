    ...
    pd: {
        number: {
            ...
            batTime: {
                ...
                role: 'value',
                name: 'batTime; a negative value indicates a discharging time, and positive value indicates a charging time',
            },
            tempWater: {
                min: 0,
                max: 60,
        ...
        array: {
            tempCoolTime: {
                ...
                role: 'list',
                name: 'Length of time when the actual temperature of the cooling zone falls in each interval: COOL_ ZONE_ MAX*TEMP_ COOL_ MAX',
            },
            appSensorAdv: {
                entity_type: 'text',
                entity_category: 'diagnostic',
            ...
            tempCoolSetTime: {
                ...
                entity_category: 'diagnostic',
                role: 'list',
                name: 'Length of time when the set temperature of the cooling zone falls in each interval: COOL_ZONE_MAX*TEMP_COOL_SET_MAX',
            },
            buttonLong: {
                entity_type: 'text',
                entity_category: 'diagnostic',
        ...
        switch: {
            ...
            sensorAdv: {
                ...
                payload_on: 'Blocked',
                name: 'Sensor detection blocking. Refer to @ST_SENSOR for data explanation. Bit: 1: Blocked; 0: Unblocked.',
                role: 'switch',
                sensorAdv: {
                    0: 'Unblocked',
                    1: 'Blocked',
