const deviceStates = {
    ...
    DisplayPropertyUpload: {
        string: {
            ...
            unknown102: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown102', role: 'info' },
            unknown512: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown512', role: 'info' },
            ...
            unknown738: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown738', role: 'info' },
            unknown739: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown739', role: 'info' },
            unknown740: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown740', role: 'info' },
            unknown741: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown741', role: 'info' },
            unknown744: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown744', role: 'info' },
            unknown745: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown745', role: 'info' },
            ...
            unknown748: { entity_type: 'text', entity_category: 'diagnostic', name: 'unknown748', role: 'info' },
        },
        number: {
            cmsBattDesignCap: {
                min: 0,
        ...
        diagnostic: {
            ...
            plugInInfoPvType: {
                ...
                role: 'info',
                plugInInfoPvType: { 0: '12v?', 1: 'solar?' },
            },
            plugInInfoDcpInFlag: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                ...
                role: 'info',
                plugInInfoDcpInFlag: { 0: 'Off?', 1: 'On?' },
            },
        },
    },
    action: {
...
const deviceStatesDict = {
    glacier55: {
        ...
        DisplayPropertyUpload: {
            ...
            unknown512: { entity: 'string' },
            unknown623: { entity: 'string' },
            unknown631: { entity: 'string' },
            setPointLeft: { entity: 'level' },
            setPointRight: { entity: 'level' },
            unknown738: { entity: 'string' },
            unknown739: { entity: 'string' },
            unknown740: { entity: 'string' },
            unknown741: { entity: 'string' },
            tempMonitorLeft: { entity: 'number' },
            tempMonitorRight: { entity: 'number' },
            unknown744: { entity: 'string' },
            unknown745: { entity: 'string' },
            unknown746: { entity: 'string' },
            unknown747: { entity: 'string' },
            unknown748: { entity: 'string' },
            iceTime749: { entity: 'number' },
...
const deviceCmd = {
    glacier55: {
        DisplayPropertyUpload: {
            ...
            setPointRight: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
            setPointLeft: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
...
message DisplayPropertyUpload {
   ...
   optional uint32 unknown102 = 102;
   ...
   optional uint32 cms_batt_pow_in_max = 460;
    optional uint32 unknown512 = 512;
    ...
    optional uint32 unknown738 = 738;
    optional uint32 unknown739 = 739;
    optional uint32 unknown740 = 740;
    optional uint32 unknown741 = 741;
    optional float temp_monitor_left = 742; //Temp Monitor Left
    optional float temp_monitor_right = 743;  //Temp Monitor Right
    optional uint32 unknown744 = 744;
    optional uint32 unknown745 = 745;
    optional float unknown746 = 746; // 125
    optional float unknown747 = 747;  //125
    optional uint32 unknown748 = 748;
    optional uint32 ice_time749 = 749; //  86467620 run time /1000 in sec
