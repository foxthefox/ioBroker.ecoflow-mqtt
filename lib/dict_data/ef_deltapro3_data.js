...
const deviceCmd = {
    deltapro3: {
        ...
        setDp3: {
            cfgDc12vOutOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 2 } },
            cfgLvAcOutOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 2 } },
            cfgHvAcOutOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 2 } },
            //cfgAcOutFreq: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
            cfgPowerOff: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 2 } },
            /*
...
const protoMsg = {
    cmdFunc: {
        ...
        53: { cmdId: { 118: 'ConfigPowerState' } }, //set
        254: {
            cmdId: {
                17: 'set_dp3',
                18: 'setReply_dp3',
                        ...
                        switch (channel) {
                            case 'BMSHeartBeatReport':
                                ...
                                if (payload[channel]['num'] !== null) {
                                    ...
                                    adapter.log.warn('num in BMSHeartBeatReport missing (deltapro3)');
                                }
                                break;
