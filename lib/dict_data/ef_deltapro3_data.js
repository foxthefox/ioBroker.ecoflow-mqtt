	...
	DisplayPropertyUpload: {
		...
		number: {
			...
			plugInInfoPvHDcAmpMax: {
				...
				role: 'value',
				name: 'plug in info pv h dc amp max',
				subrole: 'number'
			},
			acOutFreq: {
				min: 49,
			...
			plugInInfoPvHChgVolMax: {
				...
				role: 'value',
				name: 'plug in info pv h chg vol max',
				subrole: 'number'
			},
			plugInInfoPvHChgAmpMax: {
				...
				device_class: 'current',
				role: 'value',
				name: 'plug in info pv h chg amp max',
				subrole: 'number'
			},
			bmsBattSoc: {
				min: 0,
			...
			plugInInfoPvLDcAmpMax: {
				...
				device_class: 'current',
				role: 'value',
				name: 'plug in info pv l dc amp max',
				subrole: 'number'
			},
			plugInInfoAcInChgPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info ac in chg pow max',
				subrole: 'number'
			},
			plugInInfo_5p8ChgPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info_5p8 chg pow max',
				subrole: 'number'
			},
			plugInInfoPvLChgVolMax: {
				...
				device_class: 'voltage',
				role: 'value',
				name: 'plug in info pv l chg vol max',
				subrole: 'number'
			},
			plugInInfoPvLChgAmpMax: {
				...
				device_class: 'current',
				role: 'value',
				name: 'plug in info pv l chg amp max',
				subrole: 'number'
			},
			plugInInfo_5p8DsgPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info_5p8 dsg pow max',
				subrole: 'number'
			},
			plugInInfoAcOutDsgPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info ac out dsg pow max',
				subrole: 'number'
			},
			plugInInfo_5p8ChgHalPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info_5p8 chg hal pow max',
				subrole: 'number'
			},
			plugInInfoAcInChgHalPowMax: {
				...
				device_class: 'power',
				role: 'value',
				name: 'plug in info ac in chg hal pow max',
				subrole: 'number'
			}
		},
		diagnostic: {
			...
			acEnergySavingOpen: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'ac energy saving open',
				acEnergySavingOpen: { '0': 'no saving?', '1': 'saving?' }
			},
			xboostEn: {
				entity_type: 'text',
				entity_category: 'diagnostic',
			...
			enBeep: {
				...
				role: 'info',
				name: 'en beep',
				enBeep: { '0': 'disabled?', '1': 'enabled?' }
			},
			cmsOilSelfStart: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				role: 'info',
				name: 'cms oil self start',
				cmsOilSelfStart: { '0': 'disabled?', '1': 'enabled?' }
			},
			energyBackupState: {
				entity_type: 'text',
				entity_category: 'diagnostic',
			...
			plugInInfoPvHChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info pv h charger flag',
				role: 'info',
			...
			llcGfciFlag: {
				...
				name: 'llc gfci flag',
				role: 'info',
				llcGfciFlag: { '0': 'Off?', '1': 'On?' }
			},
			devSleepState: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'dev sleep state',
				role: 'info',
			...
			multiBpChgDsgMode: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'multi bp chg dsg mode',
				role: 'info',
				multiBpChgDsgMode: { '0': 'Never', '1': 'automatic', '2': 'main bat prio' }
			},

			plugInInfoPvLType: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info pv l type',
				role: 'info',
			...
			plugInInfo_4p8_1InFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_1 in flag',
				role: 'info',
			...
			plugInInfo_4p8_2InFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_2 in flag',
				role: 'info',
			...
			plugInInfoPvLChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info pv l charger flag',
				role: 'info',
			...
			plugInInfo_4p8_1DsgChgType: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_1 dsg chg type',
				role: 'info',
				plugInInfo_4p8_1DsgChgType: { '0': 'reserved', '1': 'charging/discharging', '2':'charging only', '3': 'discharging only' }
			},
			plugInInfo_4p8_2DsgChgType: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_2 dsg chg type',
				role: 'info',
			...
			plugInInfoAcChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info ac charger flag',
				role: 'info',
			...
			plugInInfo_5p8ChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_5p8 charger flag',
				role: 'info',
			...
			plugInInfo_5p8RunState: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_5p8 run state',
				role: 'info',
			...
			plugInInfo_4p8_1ChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_1 charger flag',
				role: 'info',
			...
			plugInInfo_4p8_1RunState: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_1 run state',
				role: 'info',
			...
			plugInInfo_4p8_2ChargerFlag: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_2 charger flag',
				role: 'info',
			...
			plugInInfo_4p8_2RunState: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				name: 'plug in info_4p8_2 run state',
				role: 'info',
	...
	setDp3: {
		switch: {
			...
			cfgAcEnergySavingOpen: {
				...
				role: 'switch',
				cfgAcEnergySavingOpen: { '0': 'off', '1': 'on' }
			}
		},
		level: {
			cfgAcStandbyTime: {
...
const deviceStatesDict = {
	deltapro3: {
		DisplayPropertyUpload: {
			...
			devStandbyTime: { entity: 'number' },
			screenOffTime: { entity: 'number' },
			acStandbyTime: { entity: 'number' },
			dcStandbyTime: { entity: 'number' },
			acAlwaysOnMiniSoc: { entity: 'number' },
			xboostEn: { entity: 'diagnostic' },
			...
			plugInInfoPvHDcAmpMax: { entity: 'number' },
			fastChargeSwitch: { entity: 'diagnostic' },
			enBeep: { entity: 'diagnostic' },
			llcGfciFlag: { entity: 'diagnostic' },
			...
			cmsMaxChgSoc: { entity: 'number' },
			cmsMinDsgSoc: { entity: 'number' },
			cmsOilOnSoc: { entity: 'number' },
			cmsOilOffSoc: { entity: 'number' },
			cmsOilSelfStart: { entity: 'diagnostic' },
			...
			acEnergySavingOpen: { entity: 'diagnostic' },
			multiBpChgDsgMode: { entity: 'diagnostic' },
			...
			plugInInfoPvLDcAmpMax: { entity: 'number' },
			...
			plugInInfoAcInChgPowMax: { entity: 'number' },
			plugInInfo_5p8ChgPowMax: { entity: 'number' },
		...
		setDp3: {
			...
			cfgBeepEn: { entity: 'switch' },
			cfgAcStandbyTime: { entity: 'level' },
			cfgDcStandbyTime: { entity: 'level' },
			cfgScreenOffTime: { entity: 'level' },
			cfgDevStandbyTime: { entity: 'level' },
			cfgLcdLight: { entity: 'level' },
			cfgHvAcOutOpen: { entity: 'switch' },
			cfgLvAcOutOpen: { entity: 'switch' },
			cfgDc12vOutOpen: { entity: 'switch' },
			cfgXboostEn: { entity: 'switch' },
			cfgMaxChgSoc: { entity: 'level' },
			cfgMinDsgSoc: { entity: 'level' },
			cfgPlugInInfoPvLDcAmpMax: { entity: 'level' },
			cfgPlugInInfoPvHDcAmpMax: { entity: 'level' },
			cfgPlugInInfoAcInChgPowMax: { entity: 'level' },
			cfgPlugInInfo5p8ChgPowMax: { entity: 'level' },
			cfgCmsOilSelfStart: { entity: 'switch' },
			cfgCmsOilOnSoc: { entity: 'level' },
			cfgCmsOilOffSoc: { entity: 'level' },
			cfgLlcGFCIFlag: { entity: 'switch' },
			cfgAcEnergySavingOpen: { entity: 'switch' },
			cfgMultiBpChgDsgMode: { entity: 'level' }
		},
		action: {
...
const deviceCmd = {
	deltapro3: {
		setDp3: {
			cfgPlugInInfoAcInChgPowMax: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 4 } }, 
			cfgPlugInInfo5p8ChgPowMax: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 4 } }, 
			cfgMinDsgSoc: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgMaxChgSoc: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }, 
			cfgDc12vOutOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }, 
			cfgLlcGFCIFlag: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgXboostEn: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			//cfgPlugInInfoPvLDcAmpMax: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			//cfgPlugInInfoPvHDcAmpMax: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgLvAcOutOpen:  { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgHvAcOutOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgBeepEn: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgAcStandbyTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }, //oder Länge 4
			cfgDcStandbyTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }, //oder Länge 4
			cfgScreenOffTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgDevStandbyTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgLcdLight: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			...
			cfgCmsOilSelfStart: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgCmsOilOnSoc: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgCmsOilOffSoc: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgBleStandbyTime: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 4 } },
			cfgAcEnergySavingOpen: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } },
			cfgMultiBpChgDsgMode: { msg: { dest: 2, cmdFunc: 254, cmdId: 17, dataLen: 3 } }
		},
		action: {
						...
						case 'setReply_dp3':
							...
							for (let state in payload[channel]) {
								if(payload[channel]['configOk']  && payload[channel]['configOk'] == true){
									if(state !== 'actionId' && state !== 'configOk'){
										let val;
										let haupd;
										val = payload[channel][state];
										haupd = await compareUpdate(
										...
										if (Object.keys(haupd).length !== 0) {
											haUpdate.push(haupd);
											//if(channel === 'cfgAcStandbyTime') adapter.setState(topic + 'DisplayPropertyUpload.acStandbyTime, val: haupd.payload )
											//else if(channel === 'cfgDcStandbyTime') adapter.setState(topic + 'DisplayPropertyUpload.dcStandbyTime, val: haupd.payload )
										}
									}
								} else {
	...
	if (state === 'latestQuotas') {
		...
		*/
		...
		switch (state) {
			case 'cfgLvAcOutOpen':
			case 'cfgHvAcOutOpen':
			case 'cfgBeepEn':	//enBeep
			case 'cfgPowerOff':
			case 'cfgDc12vOutOpen': //
			case 'cfgLlcGFCIFlag':
			case 'cfgXboostEn': //xboostEn
			case 'cfgAcEnergySavingOpen':	//acEnergySavingOpen
			case 'cfgCmsOilSelfStart':	//cmsOilSelfStart
				muster['header']['pdata'] = {};
				muster['header']['pdata'][state] = value ? 1 : 0;
				muster['header']['dataLen'] = cmd['msg']['dataLen'] || 3;
				break;
			case 'cfgPlugInInfoAcInChgPowMax':
			case 'cfgPlugInInfo5p8ChgPowMax':	
				muster['header']['pdata'] = {};
				muster['header']['pdata'][state] = parseInt(String(value)); //int
				muster['header']['dataLen'] = cmd['msg']['dataLen'] || 4;
				break;
			case 'cfgAcStandbyTime': //acStandbyTime
			case 'cfgDcStandbyTime': //dcStandbyTime
			case 'cfgBleStandbyTime':	//bleStandbyTime		
				muster['header']['pdata'] = {};
				muster['header']['pdata'][state] = parseInt(String(value)); //int
				//todo ermittlung len
				//muster['header']['dataLen'] = cmd['msg']['dataLen'] || 4;
				break;	
			case 'cfgMinDsgSoc': //cmsMinDsgSoc
			case 'cfgMaxChgSoc': //cmsMaxChgSoc
			case 'cfgScreenOffTime': //screenOffTime
			case 'cfgDevStandbyTime':	//devStandbyTime
			case 'cfgLcdLight':	//lcdLight
			case 'cfgCmsOilOnSoc': //cmsCmsOilOnSoc
			case 'cfgCmsOilOffSoc':	//cmsCmsOilOffSoc
				muster['header']['pdata'] = {};
				muster['header']['pdata'][state] = parseInt(String(value)); //int
				muster['header']['dataLen'] = cmd['msg']['dataLen'] || 3;
				break;		
			case 'cfgMultiBpChgDsgMode': //multiBpChgDsgMode
				//mode umsetzen
				break;			
			default:
...
message set_dp3 {
	...
	optional int32 cfgBeepEn = 9;
    optional int32 cfgAcStandbyTime = 10;
    optional int32 cfgDcStandbyTime = 11;
    optional int32 cfgScreenOffTime = 12;
	optional int32 cfgDevStandbyTime = 13;
    optional int32 cfgLcdLight = 14;
    optional int32 cfgHvAcOutOpen = 15;
    optional int32 cfgLvAcOutOpen = 16;
    optional int32 cfgDc12vOutOpen = 18;
    optional int32 cfgXboostEn = 25;
    optional int32 cfgMaxChgSoc = 33;
    optional int32 cfgMinDsgSoc = 34;
    optional int32 cfgPlugInInfoPvLDcAmpMax = 52;
    optional int32 cfgPlugInInfoPvHDcAmpMax = 53;
    optional int32 cfgPlugInInfoAcInChgPowMax= 54;
    optional int32 cfgPlugInInfo5p8ChgPowMax = 56;
    optional int32 cfgCmsOilSelfStart = 58;
    optional int32 cfgCmsOilOnSoc = 59;
	optional int32 cfgCmsOilOffSoc = 60;
    optional int32 cfgLlcGFCIFlag = 61;
    optional int32 cfgAcEnergySavingOpen = 99;
    optional int32 cfgMultiBpChgDsgMode = 100;
	optional int32 lowDischargeLimitCmd = 102; //not EF-API
	optional int32 unknown167 = 167;
	// cfgBleStandbyTime //Bluetooth timeout.
	// fastChargeSwitch
}
