...
message TimeTaskItemV2 {
  optional uint32 task_index = 1;
  optional int32 is_cfg = 2; //bool
  optional int32 is_enable = 3; //bool
...
message DisplayPropertyUpload { 
   ...
   optional int32 plug_in_info_pv_l_charger_flag = 170; //bool
   optional int32 plug_in_info_pv_h_charger_flag = 171; //bool
   ...
   optional int32 llc_GFCI_flag = 200; //bool
   optional int32 plug_in_info_ac_charger_flag = 202; //bool
   optional int32 plug_in_info_5p8_charger_flag = 203; //bool
   optional uint32 plug_in_info_5p8_run_state = 204;
   optional int32 plug_in_info_4p8_1_charger_flag = 205; //bool
   optional uint32 plug_in_info_4p8_1_run_state = 206;
   optional int32 plug_in_info_4p8_2_charger_flag = 207; //bool
   ...
   optional int32 ac_hv_always_on = 283; //bool
   optional int32 ac_lv_always_on = 284; //bool
   ...
   optional int32 generator_pv_hybrid_mode_open = 451; //bool
   optional uint32 generator_pv_hybrid_mode_soc_max = 452;
   optional int32 generator_care_mode_open = 453; //bool
   optional uint32 generator_care_mode_start_time = 454;
   optional int32 ac_energy_saving_open = 455; //bool
...
message setReply_dp3 {
    ...
    optional int32 configOk = 2; //bool
    optional uint32 cfg_utc_time = 6;
    optional int32 cfg_utc_timezone = 7;
    optional int32 enBeep = 9;
    optional int32 acStandbyTime = 10;
