    ...
    cmdFunc: {
        ...
        96: {
            cmdId: {
                ...
                106: 'EMSSetConfigCmd',
                107: 'EMSGetConfigCmd', // DC303 GET_CONFIG
                108: 'BPChangeReport',
                109: 'DcChangeReport', //DCDC_CHANGE_REPORT DC303
                110: 'DcStaReport2', // DCDC_OPERATION_DATA_REPORT DC303
                111: 'CloudBmsInfoReport', //BMS_CLOUD_HEARTBEAT_REPORT DC303
                112: 'SysBatChgDsgSet',
        ...
        254: {
            cmdId: { 32: 'EnergyTotalReport' }, // ENERGY_STREAM_TOTAL
        },
    },
};
...
message setValue {
    ...
    message sentEMSHeartbeatReport {
        setHeader1 header = 1;
    } 
    message sentEnergyStreamItem {
        setHeader2 header = 1;
    } 
    message sentBPChangeReport {
        setHeader3 header = 1;
    } 
    message sentDcChangeReport {
        setHeader4 header = 1;
    } 
    message sentErrorChangeReport {
        setHeader5 header = 1;
    } 
    message sentDcStaReport2 {
        setHeader6 header = 1;
    } 

 message setHeader6 {
    DcStaReport2 pdata = 1;
    int32 src = 2;
    int32 dest = 3;
    int32 d_src = 4;
    int32 d_dest = 5;
