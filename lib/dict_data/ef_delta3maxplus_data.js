const deviceStates = {
    RuntimePropertyUpload: {
        ...
        string: {
            ...
            llcFsmstate: { entity_type: 'text', entity_category: 'diagnostic', name: 'llc Fsm State', role: 'info' },
        },
        icon: {
            bmsOverloadIcon: {
                entity_type: 'text',
...
const deviceStatesDict = {
    delta3maxplus: {
        RuntimePropertyUpload: {
            ...
            pvVinRef: { entity: 'number' },
            pv2VinRef: { entity: 'number' },
...
message BMSHeartBeatReport {
  ...
  /**
    83 not in reference object 
    84 not in reference object 
    85 not in reference object 
    86 not in reference object 
    87 not in reference object 
   **/
}
...
message RuntimePropertyUpload { 
  ...
  optional float llc_bus_vol = 386;
   ...
   optional int32 pd_dcdc_comm_err = 444; //bool
   optional int32 pd_inv_comm_err = 445; //bool
   optional uint32 dcdc_firm_ver = 446;
   optional uint32 inv_firm_ver = 447;
   optional float plug_in_info_dcp_amp = 448;
   /**
    970 not in reference object 
    973 not in reference object 
    974 not in reference object 
    **/
}
...
message DisplayPropertyUpload { 
   ...
   optional int32 ac_always_on_flag = 22; //bool
   ...
   optional int32 plug_in_info_ac_charger_flag = 202; //bool
   ...
   optional int32 cms_oil_self_start = 274; //bool
   ...
   optional int32 plug_in_info_pv_flag = 362; //bool
   optional uint32 plug_in_info_pv_type = 363;
   optional int32 plug_in_info_pv_charger_flag = 364; //bool
   ...
   optional int32 plug_in_info_pv2_flag = 421; //bool
   ...
   optional int32 plug_in_info_dcp_in_flag = 426; //bool
   optional uint32 plug_in_info_dcp_type = 427;
   optional uint32 plug_in_info_dcp_detail = 428;
   optional int32 plug_in_info_pv2_charger_flag = 430; //bool
   ...
   optional int32 plug_in_info_dcp_charger_flag = 435; //bool
   ...
   optional int32 storm_pattern_enable = 467; //bool
   optional int32 storm_pattern_open_flag = 468; //bool
   optional int32 storm_pattern_end_time = 469; //bool
   /**
    602 not in reference object 
    968 not in reference object 
    969 not in reference object 
    971 not in reference object 
    972 not in reference object 
    975 not in reference object 
    977 not in reference object 
    979 not in reference object 
    1265 not in reference object 
    1279 not in reference object 
    1460 not in reference object 
    1539 not in reference object 
    **/
}
