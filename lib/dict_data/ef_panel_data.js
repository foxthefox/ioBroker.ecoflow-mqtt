		...
		cfg: {
			param: {
				lowBattery: {
					...
					entity_type: 'sensor',
					device_class: 'battery',
					name: 'Charge low power percentage',
					role: 'value'
				},
				chChargeWatt: {
					min: 0,
				...
				hightBattery: {
					...
					entity_type: 'sensor',
					device_class: 'battery',
					name: 'Charge high power percentage',
					role: 'value'
				}
			},
			comCfg: {
	...
	panel: {
		...
		loadCmdChCtrlInfos: {
			...
			ctrlMode_0: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 0, cmdSet: 11, id: 16 }
			},
			ctrlSta_1: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_1: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 1, cmdSet: 11, id: 16 }
			},
			ctrlSta_2: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_2: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 2, cmdSet: 11, id: 16 }
			},
			ctrlSta_3: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_3: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 3, cmdSet: 11, id: 16 }
			},
			ctrlSta_4: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_4: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 4, cmdSet: 11, id: 16 }
			},
			ctrlSta_5: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_5: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 5, cmdSet: 11, id: 16 }
			},
			ctrlSta_6: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_6: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 6, cmdSet: 11, id: 16 }
			},
			ctrlSta_7: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_7: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 7, cmdSet: 11, id: 16 }
			},
			ctrlSta_8: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_8: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 8, cmdSet: 11, id: 16 }
			},
			ctrlSta_9: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_9: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 9, cmdSet: 11, id: 16 }
			}
		...
		backupCmdChCtrlInfos: {
			...
			ctrlMode_10: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 10, cmdSet: 11, id: 17 }
			},
			ctrlSta_11: {
				valName: 'sta',
				moduleType: 0,
			...
			ctrlMode_11: {
				...
				moduleType: 0,
				operateType: 'TCP',
				params: { sta: 0, ctrlMode: 0, ch: 11, cmdSet: 11, id: 17 }
			}
		},
