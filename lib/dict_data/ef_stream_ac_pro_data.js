...
message ControllableLoadReq {
  optional string sn = 1;
  optional int32 remain_power = 2;
...
message DevRequest {
  ...
  optional ControllableLoadReq controllable_load_req = 12;
}
...
message RuntimePropertyUpload {
  ...
  optional uint32 ongrid_vout_rms = 1415; //*0.1
  optional uint32 offgrid_vout1_rms = 1416; //*0.1
  optional uint32 offgrid_vout2_rms = 1417; //*0.1
  ...
  optional uint32 unknown1624 = 1624; //energy?
  optional uint32 unknown1625 = 1625; //energy?
  optional uint32 unknown1628 = 1628;
}
...
enum GRID_STD_CODE {
  ...
  GRID_STD_CODE_JAPAN = 34;
  GRID_STD_CODE_PHILIPPINES = 35;
...
message DisplayPropertyUpload {
   ...
   optional uint32 series_connect_device_id = 1285;
    ...
    optional int32 sys_offgrid  = 1296; //bool 
    optional int32 cascade_sys_output_pwr_diff  = 1307; //5
    optional int32 series_power = 1424; //1
    optional uint32 sys_grid_in_pwr_limit = 1495; //3600
    optional bool socket1_pwr_in_unbind = 1496;
    optional bool socket2_pwr_in_unbind = 1497;
    optional uint32 feed_grid_safety_pow_max = 1543;

     optional ControllableLoadList controllable_load_list = 1549;
     optional AllTimerTask timetask584 = 584;
     //optional AllTimerTask cfg_all_timer_task = 595;
}
...
message ConfigWrite {
  ...
  optional string scoket2_bind_device_sn = 566;
   optional uint32 cfg_sys_grid_in_pwr_limit = 579;
   optional uint32 cfg_feed_grid_safety_pow_max = 591;
   optional ControllableLoadList cfg_controllable_load_list = 592;
   optional ControllableLoadHeartbeat controllable_load_heartbeat = 593;
   optional AllTimerTask cfg_all_timer_task = 595;
}
