        ...
        case 'loadPower1':
            {
                ...
                muster['header']['pdata'] = {};
                muster['header']['pdata']['cfgUtcTime'] = timestamp;
                muster['header']['pdata']['cfgFeedGridModePowLimit'] = parseInt(feedGridModePowLimit.val); //int
                muster['header']['pdata']['cfgDayResidentLoadList'] = {};
                let load = {};
                if (startMin) {
                    load['starMin'] = parseInt(startMin.val); //int
                }
                if (endMin) {
                    load['endMin'] = parseInt(endMin.val); //int
                }
                load['loadPower'] = parseInt(value); //int
                muster['header']['pdata']['cfgDayResidentLoadList']['load'] = [];
                muster['header']['pdata']['cfgDayResidentLoadList']['load'].push(load);
                muster['header']['dataLen'] = 21;
            }
            break;
