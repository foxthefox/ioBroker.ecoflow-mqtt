    ...
    DisplayPropertyUpload: {
        ...
        diagnostic: {
            ...
            btnDc_12vOutSwitch: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'btn Dc_12v Out Switch',
                role: 'info',
                btnDc_12vOutSwitch: { '0': 'off?', '1': 'on?' }
            }
        },
        level: {
            cmsMaxChgSoc: {
...
const deviceStatesDict = {
    stream_ac_pro: {
        ...
        DisplayPropertyUpload: {
            ...
            btnDc_12vOutSwitch: { entity: "diagnostic" },
            ...
            plugGetPvSum: { entity: "number" },
            powGetSysLoadFromBp: { entity: "number" },
            powGetSysLoadFromGrid: { entity: "number" },
            powGetOutlet1: { entity: "number" },
            powGetOutlet2: { entity: "number" },
...
message DisplayPropertyUpload {
   ...
   optional uint32 btn_dc_12v_out_switch = 75; //bool
   ...
   optional int32 pow_sys_ac_out_max = 521;
   ...
   optional float plug_get_pv_sum = 1002;
   optional float pow_get_sys_load_from_bp = 1003;
   optional float pow_get_sys_load_from_grid = 1004;
   optional float pow_get_outlet1 = 1210;
   optional float pow_get_outlet2 = 1211;
