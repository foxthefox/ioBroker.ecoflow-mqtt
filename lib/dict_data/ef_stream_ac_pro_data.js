...
message Task {
    ...
    //10 string or bytes
    optional DeviceTask devicetask = 11;
    optional int32 unknown12 = 12;

}

message DeviceTask {
    optional int32 enable1 = 1;
    repeated DeviceSet deviceset = 3;
}

message DeviceSet {
    optional string dev_sn1 = 1;
    optional int32 chargeLimSoc2 = 2;
    optional int32 load3 = 3;
}
...
message DisplayPropertyUpload {
   ...
   optional uint32 series_connect_device_id = 1285;
    ...
    optional int32 unknown1296 = 1296;
    optional int32 unknown1307 = 1307; //5
    optional int32 unknown1424 = 1424; //1
    optional int32 unknown1495 = 1495; //3600
    optional int32 unknown1496 = 1496;
    optional int32 unknown1497 = 1497;
    optional int32 unknown1543 = 1543;
    //1549 string/bytes
     optional TimeTaskTest timetask584 = 584;
     optional TimeTaskTest timetask595 = 595;
}
...
message ConfigWrite {
  ...
  optional TimeTaskTest timetask = 595;
