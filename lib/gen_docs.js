function createobj(device) {
	...
	if (
		...
		console.log('panel2');
		states = require('./dict_data/ef_panel2_data.js').panel2States;
		dict = require('./dict_data/ef_panel2_data.js').panel2StatesDict[device];
		ranges = require('./dict_data/ef_panel2_data.js').panel2Ranges[device];
		cmd = require('./dict_data/ef_panel2_data.js').panel2Cmd[device];
	} else if (device === 'powerocean') {
		console.log('powerocean');
		states = require('./dict_data/ef_powerocean_data.js').poweroceanStates;
		dict = require('./dict_data/ef_powerocean_data.js').poweroceanStatesDict[device];
		ranges = require('./dict_data/ef_powerocean_data.js').poweroceanRanges[device];
		cmd = require('./dict_data/ef_powerocean_data.js').poweroceanCmd[device];
	} else if (device === 'deltaproultra') {
		console.log('deltaproultra');
		states = require('./dict_data/ef_deltaproultra_data.js').deltaproultraStates;
		dict = require('./dict_data/ef_deltaproultra_data.js').deltaproultraStatesDict[device];
		ranges = require('./dict_data/ef_deltaproultra_data.js').deltaproultraRanges[device];
		cmd = require('./dict_data/ef_deltaproultra_data.js').deltaproultraCmd[device];
		...
		dict = require('./dict_data/ef_deltapro3_data.js').deviceStatesDict[device];
		...
		console.log('plug');
		states = require('./dict_data/ef_plug_data.js').plugStates;
		dict = require('./dict_data/ef_plug_data.js').plugStatesDict[device];
		ranges = require('./dict_data/ef_plug_data.js').plugRanges[device];
		cmd = require('./dict_data/ef_plug_data.js').plugCmd[device];
	} else {
		console.log('pstream');
		states = require('./dict_data/ef_pstream_data.js').pstreamStates;
		ranges = require('./dict_data/ef_pstream_data.js').pstreamRanges[device];
		cmd = require('./dict_data/ef_pstream_data.js').pstreamCmd[device];
		if (device === 'pstream600' || device === 'pstream800') {
			device = 'pstream';
		}
		dict = require('./dict_data/ef_pstream_data.js').pstreamStatesDict[device];
