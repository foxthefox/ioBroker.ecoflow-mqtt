...
/**
 * @param {object} devicestates - dictionary of states
 * @param {string} key - key
 * @param {{ entity: string | number; }} link2 - channel
 * @param {string} key2 - datapoint
 * @param {object} errors - collection of problems
 * @param {string} deviceID - serial#
 * @param {string} type - device type
 * @param {string} topic - topic
 * @param {{ name: string; sw_version: string; }} [origin] - origin
 */
