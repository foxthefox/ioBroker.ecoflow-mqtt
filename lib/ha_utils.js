			...
			if (link2.entity !== 'array' && link2.entity !== 'icon' && key !== 'info') {
                ...
                */
				...
				if (bat1 && key === 'bmsMaster') {
					...
					let discovery_message1 = discovery_message;
					discovery_message1['state_topic'] = topic + '/' + deviceID + '_' + 'bmsSlave1' + '/' + key2;
					msg1.payload = discovery_message1;
					msgqeue.push(msg1);
				}
				if (bat2 && key === 'bmsMaster') {
					...
					let discovery_message2 = discovery_message;
					discovery_message2['state_topic'] = topic + '/' + deviceID + '_' + 'bmsSlave2' + '/' + key2;
					msg2.payload = discovery_message2;
					msgqeue.push(msg2);
				}
			}
		});
