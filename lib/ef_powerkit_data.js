const powerkitStates = {
	...
	lddc: {
		array: { errorCode: {}, dcChCur: {}, dcChWatt: {}, errorCodeAdd: {} },
		number: {
			dcInVol: {
				min: 0,
				max: 60,
...
const powerkitStatesDict = {
	powerkit: {
		...
		onLineModuleSnList: {
			customData: { entity: 'string' },
			loaderVersion: { entity: 'string' },
			moduleAddr: { entity: 'string' },
			moduleDAddr: { entity: 'string' },
			moduleDetail: { entity: 'string' },
			moduleSn: { entity: 'string' },
			moduleType: { entity: 'string' },
			moduleVersion: { entity: 'string' }
		},
