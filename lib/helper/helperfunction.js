 ...
 * @param {{ [x: string]: { [x: string]: any; }; }} protoObj
 */
...
/**
 * @param {{ [x: string]: { [x: string]: any; }; }} obj
 * @param {{ [x: string]: { [x: string]: any; }; }} names
 */
 ...
 * @param {{ [x: string]: { [x: string]: { [x: string]: { [x: string]: any; }; }; }; }} baseItem
 */
