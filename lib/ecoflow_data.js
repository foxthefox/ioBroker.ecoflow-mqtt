	...
	InverterHeartbeat2: {
		number: {
			...
			streamPowPlugsPos: {
				...
				entity_type: 'sensor',
				device_class: 'power',
				name: 'Power to plugs from PowerStream',
				role: 'indicator',
				subrole: 'number'
			},
			uptime: {
		...
		string: {
			pv1_active_1: { name: 'X_Unknown_1', role: 'info' },
			pv1_status_2: { name: 'X_Unknown_2', role: 'info' },
			pv2_active_3: { name: 'X_Unknown_3', role: 'info' },
			pv2_status_4: { name: 'X_Unknown_4', role: 'info' },
	...
	plug_heartbeat: {
		number: {
			...
			cntDevices: {
				...
				mult: 1,
				entity_type: 'sensor',
				name: 'Amount of PowerStream/Plugs',
				role: 'indicator',
				subrole: 'number'
			},
			streamOutputPower: {
			...
			streamPowerPlugs: {
				...
				entity_type: 'sensor',
				device_class: 'power',
				name: 'Power Stream output for plugs',
				role: 'indicator',
				subrole: 'number'
			},
			wifiRssi: {
...
const pstreamStatesDict = {
	pstream: {
		...
		InverterHeartbeat2: {
			pv1_active_1: { entity: 'string' },
			pv1_status_2: { entity: 'string' },
			pv2_active_3: { entity: 'string' },
			pv2_status_4: { entity: 'string' },
			...
			streamPowPlugsPos: { entity: 'number' }, // Smartplug Verbrauch (positiver Wert) ?
			...
			gridWatt: { entity: 'number' },
			streamPowPlugsNeg: { entity: 'string' }, // Smartplug Verbrauch (negativer Wert) ?
	...
	plug: {
		plug_heartbeat: {
			...
			cntDevices: { entity: 'string' },
			streamOutputPower: { entity: 'number' },
			streamPowerPlugs: { entity: 'number' },
...
const pstationStatesDict = {
	...
	deltamax: {
		bmsMaster: {
			...
			cellTemp: { entity: 'icon' }, //array
			cellVol: { entity: 'icon' }, //array
