...
const pstationStates = {
	...
	pd: {
		...
		switch: {
			...
			//new DeltaPro FW
			acautooutConfig: { entitiy: 'switch' }
		},
		diagnostic: {
			carState: {
				entity_type: 'text',
...
const pstationStatesDict = {
	...
	deltapro: {
		...
		pd: {
			...
			iconSolarPanelMode: { entity: 'icon' },
			//new DeltaPro FW
			watthisconfig: { entitiy: 'string' },
			minAcoutSoc: { entitiy: 'number' },
			relayswitchcnt: { entitiy: 'string' },
			hysteresisAdd: { entitiy: 'string' },
			acautooutConfig: { entitiy: 'switch' },
			bppowerSoc: { entitiy: 'level' },
			acautooutPause: { entitiy: 'number' }
		},
		mppt: {
			carOutVol: { entity: 'number' },
			carState: { entity: 'switch' },
