...
const pstreamStatesDict = {
	...
	plug: {
		plug_heartbeat: {
			...
			cntPlugs_32: { entity: 'string' },
			streamPower_33: { entity: 'string' },
			sumInclPlugs_34: { entity: 'string' },
			unknown35: { entity: 'string' },
			unknown36: { entity: 'string' },
			unknown37: { entity: 'string' },
			unknown38: { entity: 'string' },
			unknown39: { entity: 'string' },
			wifiRssi_40: { entity: 'string' } // WLAN Stärke?
		},
		energy: {
			watth5: { entity: 'number' },
			watth6: { entity: 'number' }
	...
	info: {
		switch: {
			...
			getAllTaskCfg: {
				...
				getAllTimeTask: { 0: 'no trigger', 1: 'trigger' }
			}
		}
	},
	//new wave2
