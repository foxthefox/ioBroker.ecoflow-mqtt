...
const pstreamStatesDict = {
	pstream: {
		...
		InverterHeartbeat2: {
			...
			streamPowPlugsNeg: { entity: 'number' }, // Smartplug Verbrauch (negativer Wert) ?
...
const pstationStates = {
	bmsMaster: {
		...
		icon: {
			...
			recv: { entity_type: 'text', entity_category: 'diagnostic', role: 'info', name: 'recv' },
			//new from deltamax
			hwEdition: { entity_type: 'text', entity_category: 'diagnostic', role: 'info', name: 'HW edition' },
			cellSeriesNum: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				role: 'info',
