	...
	inv: {
		...
		diagnostic: {
			fanState: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Fan state: 0: disabled; 1: Level 1; 2: Level 2; 3: Level 3',
			...
			chgPauseFlag: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'AC charging pause flag: 1: charging stopped',
				chgPauseFlag: { 1: 'charging stopped' }
			},
			chargerType: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Charger type: 1: AC charging; 2: DC adapter charging; 3: solar charging; 4: CC; 5: BC',
				chargerType: { 1: 'AC charging', 2: 'DC adapter charging', 3: 'solar charging', 4: 'CC', 5: 'BC' }
			},
			dischargeType: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Discharging type: 1: AC discharging; 2: PR; 3: BC',
				dischargeType: { 1: 'AC discharging', 2: 'PR', 3: 'BC' }
			},
			acDipSwitch: {
				entity_type: 'text',
				entity_category: 'diagnostic',
				role: 'info',
				name: 'AC fast/slow charging dip switch: 0: unknown; 1: fast charging mode; 2: slow charging mode',
			...
			cfgAcOutFreq: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Inverter output frequency (Hz): 1: 50 Hz; 2: 60 Hz; 0xff: ignored',
	...
	mppt: {
		...
		switch: {
			carState: {
				...
				device_class: 'switch',
				role: 'switch',
				name: 'Car charger switch setting 0 off, 1 on',
				payload_off: 'off',
				payload_on: 'on',
				carState: { '0': 'off', '1': 'on' }
			}
		...
		diagnostic: {
			xt60ChgType: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'XT60 charging type: 0: not detected; 1: MPPT; 2: adapter',
			...
			chgState: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Charging state: 0: disabled; 1: charging; 2: standby (DC charging stopped during AC charging)',
			...
			dc24vState: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'DCDC24 switch state: 0: off; 1: on',
			...
			chgPauseFlag: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'PV charging pause flag: 1: charging stopped',
				chgPauseFlag: { 1: 'charging stopped' }
			}
		}
	},
	pd: {
		...
		switch: {
			beepState: {
				...
				role: 'switch',
				name: 'Beep status0 Normal, 1 Quiet',
				payload_off: 'normal',
				payload_on: 'quiet',
			...
			dcOutState: {
				...
				entity_category: 'switch',
				role: 'switch',
				name: 'DC button state: 0: off; 1: on',
				payload_off: 'off',
				payload_on: 'on',
		...
		diagnostic: {
			...
			sysChgDsgState: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Charging/discharging state on screen: 1: discharged; 2: charged',
			...
			iconRechgTimeMode: {
				...
				entity_category: 'diagnostic',
				role: 'info',
				name: 'Charge icon mode: 0: normal; 1: blinking',
...
const pstationStatesDict = {
	...
	deltapro: { mppt: { beepState: { special: 'deltapro' } } },
	river2max: {
		inv: {
...
const pstationRanges = {
	delta: {
		...
		cfgSlowChgWatts: { min: 200, max: 2200 },
		cfgDcChgCurrent: { min: 0, max: 13 }
	},
	deltamax: {
		cfgFastChgWatts: { min: 100, max: 1400 },
...
const pstationCmd = {
	...
	deltapro: {
		pd: {
			acautooutConfig: { moduleType: 0, operateType: 'TCP', params: { id: 95, acautooutConfig: 'VALUE' } },
			bppowerSoc: {
				moduleType: 0,
				operateType: 'TCP',
				params: { id: 94, isConfig: 'VALUE', bpPowerSoc: 0, minDsgSoc: 0, maxChgSoc: 0 }
			},
			bpPowerSoc: {
				moduleType: 0,
				operateType: 'TCP',
				params: { isConfig: 1, bpPowerSoc: 'VALUE', minDsgSoc: 0, maxChgSoc: 0, id: 94 }
			}
		}
	},

	delta2: {
		acAutoOnCfg: { moduleType: 1, operateType: 'acAutoOn', params: { cfg: 'VALUE' } },
		pvChgPrioSet: { moduleType: 1, operateType: 'pvChangePrio', params: { pvChangeSet: 'VALUE' } }
	}
};
