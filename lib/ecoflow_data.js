...
const pstationStatesDict = {
	...
	generator: {
		oil: {
			oilVal: { entity: 'string' },
			acPower: { entity: 'number' },
			acState: { entity: 'diagnostic' },
			num: { entity: 'string' },
			sysMode: { entity: 'diagnostic' },
			type: { entity: 'string' },
			...
			errCode: { entity: 'diagnostic' },
			ceelId: { entity: 'string' },
			dcOutState: { entity: 'diagnostic' },
			motorState: { entity: 'diagnostic' },
...
const pstationCmd = {
	...
	panel: {
		...
		recharge1: {
			...
			operateType: 'TCP',
			params: {
				on: { sta: 2, ctrlMode: 1, ch: 10, cmdSet: 11, id: 17 },
				off: { sta: 0, ctrlMode: 0, ch: 10, cmdSet: 11, id: 17 }
			}
		},
		recharge2: {
			valName: 'ch',
			...
			operateType: 'TCP',
			params: {
				on: { sta: 2, ctrlMode: 1, ch: 11, cmdSet: 11, id: 17 },
				off: { sta: 0, ctrlMode: 0, ch: 11, cmdSet: 11, id: 17 }
			}
		},
		overload: {
			valName: 'eps',
