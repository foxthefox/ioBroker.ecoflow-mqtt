    ...
    pd: {
        ...
        level: {
            ...
            wteFthEn: {
                ...
                name: 'bit1 (main switch of automatic drainage function): 0: On; 1: Off bit0: (in Cool/Fan mode): 0: Manual drainage; 1: No drainage (in Heat mode): 0: Off; 1: Physical drainage (In Cool/Fan mode: 0: Turn on Manual drainage，1: Turn on No drainage, 2: Turn off Manual drainage, 3 Turn off No drainage In Heat Mode: 0: Turn off, 1: Turn on Manual drainage， 3: Turn off Manual drainage)',
                role: 'level',
                subrole: 'mode',
            },
            rgbState: {
        ...
        array: {
            ...
            envTempRangeCnt: {
                ...
                entity_category: 'diagnostic',
                role: 'list',
                name: 'Count of ambient temperature intervals; the range is 0-55 degrees Celsius; each interval covers 5 degrees; it is counted every time the button is pressed to power on.',
            },
            sacWattRangeTime: {
                entity_type: 'text',
                entity_category: 'diagnostic',
                name: 'Length of time the device power falls in each interval (sec). The intervals include 101 W-200 W, 201 W-300 W, 301 W-400 W, 401 W-500 W, 501 W-600 W, and 601 W-700 W.',
                role: 'list',
            },
            tempCoolTime: {
                entity_type: 'text',
    ...
    power: {
        number: {
            ...
            tempMax: {
                ...
                device_class: 'temperature',
                role: 'value',
                name: 'The highest temperature among the four temperatures: MPPT temperature, PFC temperature, LLC high-voltage side temperature, and LLC low-voltage side temperature',
            },
            tempMin: {
                min: 0,
                max: 80,
                ...
                device_class: 'temperature',
                role: 'value',
                name: 'The minimum temperature value among the four temperatures: MPPT temperature, PFC temperature, LLC high-voltage side temperature, and LLC low-voltage side temperature',
            },
