...
const pstreamStatesDict = {
	...
	plug: {
		plug_heartbeat: {
			...
			dynWattEnable_39: { entity: 'string' },
...
const pstationStates = {
	...
	pd: {
		...
		icon: {
			...
			errorTimeBldc: { name: 'array errors?' },
			//new wave2
			pdResv: { name: 'Reserve' },
			resv: { name: 'Reserve' }
		}
...
const pstationStatesDict = {
	...
	wave2: {
		...
		bmsMaster: {
			...
			dsgWattRangeTime: { entity: 'string' },
			usbWattRangeTime: { entity: 'string' },
			typecWattRangeTime: { entity: 'string' },
	...
	glacier: {
		pd: {
			...
			errorTimeBldc: { entity: 'icon' }, //array
			resvP: { entity: 'icon' },
			resvD: { entity: 'icon' },
			resvB: { entity: 'icon' }
		},
